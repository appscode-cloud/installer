...
require (
	...
	go.bytebuilders.dev/resource-model v0.3.1-0.20250717070043-3904a284306d
	go.bytebuilders.dev/ui-wizards v0.20.0
	...
	kubeops.dev/installer v0.0.0-20250709205805-b8bdf921a01f

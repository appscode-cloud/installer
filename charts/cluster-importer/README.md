...
$ helm repo update
$ helm search repo appscode/cluster-importer --version=v2025.7.31
$ helm upgrade -i cluster-importer appscode/cluster-importer -n ace-system --create-namespace --version=v2025.7.31
```
...
```bash
$ helm upgrade -i cluster-importer appscode/cluster-importer -n ace-system --create-namespace --version=v2025.7.31 --set registryFQDN=ghcr.io
```
...
```bash
$ helm upgrade -i cluster-importer appscode/cluster-importer -n ace-system --create-namespace --version=v2025.7.31 --values values.yaml
```

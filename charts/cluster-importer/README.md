...
$ helm repo update
$ helm search repo appscode/cluster-importer --version=v2024.8.21
$ helm upgrade -i cluster-importer appscode/cluster-importer -n ace-system --create-namespace --version=v2024.8.21
```
...
```bash
$ helm upgrade -i cluster-importer appscode/cluster-importer -n ace-system --create-namespace --version=v2024.8.21 --set registryFQDN=ghcr.io
```
...
```bash
$ helm upgrade -i cluster-importer appscode/cluster-importer -n ace-system --create-namespace --version=v2024.8.21 --values values.yaml
```

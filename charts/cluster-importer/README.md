...
$ helm repo update
$ helm search repo appscode/cluster-importer --version=v2025.1.17
$ helm upgrade -i cluster-importer appscode/cluster-importer -n ace-system --create-namespace --version=v2025.1.17
```
...
```bash
$ helm upgrade -i cluster-importer appscode/cluster-importer -n ace-system --create-namespace --version=v2025.1.17 --set registryFQDN=ghcr.io
```
...
```bash
$ helm upgrade -i cluster-importer appscode/cluster-importer -n ace-system --create-namespace --version=v2025.1.17 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/cluster-importer --version=v2024.6.18
$ helm upgrade -i cluster-importer appscode/cluster-importer -n ace-system --create-namespace --version=v2024.6.18
```
...
```bash
$ helm upgrade -i cluster-importer appscode/cluster-importer -n ace-system --create-namespace --version=v2024.6.18 --set registryFQDN=ghcr.io
```
...
```bash
$ helm upgrade -i cluster-importer appscode/cluster-importer -n ace-system --create-namespace --version=v2024.6.18 --values values.yaml
```

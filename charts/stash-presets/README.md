...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2024.6.18
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.6.18
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.6.18 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.6.18 --values values.yaml
```

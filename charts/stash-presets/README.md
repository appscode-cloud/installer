...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2024.10.17
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.10.17
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.10.17 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.10.17 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2025.10.31
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.10.31
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.10.31 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.10.31 --values values.yaml
```

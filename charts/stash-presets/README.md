...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2025.7.16
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.7.16
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.7.16 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.7.16 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2024.7.2
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.7.2
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.7.2 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.7.2 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2026.5.22
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2026.5.22
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2026.5.22 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2026.5.22 --values values.yaml
```

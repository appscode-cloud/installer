...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2024.7.4
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.7.4
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.7.4 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.7.4 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2025.12.15
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.12.15
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.12.15 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.12.15 --values values.yaml
```

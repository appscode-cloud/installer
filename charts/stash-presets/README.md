...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2024.12.9
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.12.9
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.12.9 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.12.9 --values values.yaml
```

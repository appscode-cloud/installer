...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2025.2.28
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.2.28
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.2.28 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.2.28 --values values.yaml
```

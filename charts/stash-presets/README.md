...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2026.4.30
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2026.4.30
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2026.4.30 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2026.4.30 --values values.yaml
```

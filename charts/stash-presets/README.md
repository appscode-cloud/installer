...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2025.3.14
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.3.14
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.3.14 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2025.3.14 --values values.yaml
```

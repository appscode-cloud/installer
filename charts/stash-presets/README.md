...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2026.7.10
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2026.7.10
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2026.7.10 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2026.7.10 --values values.yaml
```

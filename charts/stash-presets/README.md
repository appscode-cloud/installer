...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2026.6.19
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2026.6.19
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2026.6.19 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2026.6.19 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/stash-presets --version=v2024.6.3
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.6.3
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.6.3 --set tool=KubeStash # Stash
```
...
```bash
$ helm upgrade -i stash-presets appscode/stash-presets -n kubeops --create-namespace --version=v2024.6.3 --values values.yaml
```

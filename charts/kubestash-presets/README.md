...
$ helm repo update
$ helm search repo appscode/kubestash-presets --version=v2023.10.18
$ helm upgrade -i kubestash-presets appscode/kubestash-presets -n kubeops --create-namespace --version=v2023.10.18
```
...
```bash
$ helm upgrade -i kubestash-presets appscode/kubestash-presets -n kubeops --create-namespace --version=v2023.10.18 --set kubestash.schedule="0 */2 * * *"
```
...
```bash
$ helm upgrade -i kubestash-presets appscode/kubestash-presets -n kubeops --create-namespace --version=v2023.10.18 --values values.yaml
```

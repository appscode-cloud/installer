...
$ helm repo update
$ helm search repo appscode/platform-opscenter --version=v2026.3.30
$ helm upgrade -i platform-opscenter appscode/platform-opscenter -n ace --create-namespace --version=v2026.3.30
```
...
```bash
$ helm upgrade -i platform-opscenter appscode/platform-opscenter -n ace --create-namespace --version=v2026.3.30 --set openfga-alerts.grafana.jobName=openfga
```
...
```bash
$ helm upgrade -i platform-opscenter appscode/platform-opscenter -n ace --create-namespace --version=v2026.3.30 --values values.yaml
```

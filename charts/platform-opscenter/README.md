...
$ helm repo update
$ helm search repo appscode/platform-opscenter --version=v2026.6.12
$ helm upgrade -i platform-opscenter appscode/platform-opscenter -n ace --create-namespace --version=v2026.6.12
```
...
```bash
$ helm upgrade -i platform-opscenter appscode/platform-opscenter -n ace --create-namespace --version=v2026.6.12 --set openfga-alerts.grafana.jobName=openfga
```
...
```bash
$ helm upgrade -i platform-opscenter appscode/platform-opscenter -n ace --create-namespace --version=v2026.6.12 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/billing-ui --version=v2024.7.4
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.7.4
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.7.4 --set replicaCount=1
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.7.4 --values values.yaml
```

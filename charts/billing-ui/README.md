...
$ helm repo update
$ helm search repo appscode/billing-ui --version=v2025.4.15
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2025.4.15
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2025.4.15 --set replicaCount=1
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2025.4.15 --values values.yaml
```

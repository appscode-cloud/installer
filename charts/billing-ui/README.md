...
$ helm repo update
$ helm search repo appscode/billing-ui --version=v2024.2.13
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.2.13
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.2.13 --set replicaCount=1
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.2.13 --values values.yaml
```

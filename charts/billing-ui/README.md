...
$ helm repo update
$ helm search repo appscode/billing-ui --version=v2023.12.5
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2023.12.5
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2023.12.5 --set replicaCount=1
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2023.12.5 --values values.yaml
```

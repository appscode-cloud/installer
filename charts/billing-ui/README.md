...
$ helm repo update
$ helm search repo appscode/billing-ui --version=v2024.4.2
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.4.2
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.4.2 --set replicaCount=1
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.4.2 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/billing-ui --version=v2024.5.3
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.5.3
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.5.3 --set replicaCount=1
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.5.3 --values values.yaml
```

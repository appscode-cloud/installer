...
$ helm repo update
$ helm search repo appscode/billing-ui --version=v2025.8.31
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2025.8.31
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2025.8.31 --set replicaCount=1
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2025.8.31 --values values.yaml
```

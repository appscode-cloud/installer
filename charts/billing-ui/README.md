...
$ helm repo update
$ helm search repo appscode/billing-ui --version=v2024.8.21
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.8.21
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.8.21 --set replicaCount=1
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2024.8.21 --values values.yaml
```

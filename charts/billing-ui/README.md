...
$ helm repo update
$ helm search repo appscode/billing-ui --version=v2023.10.18
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2023.10.18
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2023.10.18 --set replicaCount=1
```
...
```bash
$ helm upgrade -i billing-ui appscode/billing-ui -n ace --create-namespace --version=v2023.10.18 --values values.yaml
```

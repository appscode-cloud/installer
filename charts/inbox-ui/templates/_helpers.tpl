...
Common labels
*/}}
{{- define "inbox-ui.labels" -}}
helm.sh/chart: {{ include "inbox-ui.chart" . }}
{{ include "inbox-ui.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "inbox-ui.selectorLabels" -}}
app.kubernetes.io/name: {{ include "inbox-ui.name" . }}

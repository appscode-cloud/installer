...
$ helm repo update
$ helm search repo appscode/inbox-ui --version=v2024.12.9
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2024.12.9
```
...
```bash
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2024.12.9 --set replicaCount=1
```
...
```bash
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2024.12.9 --values values.yaml
```

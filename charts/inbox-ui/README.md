...
$ helm repo update
$ helm search repo appscode/inbox-ui --version=v2024.4.2
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2024.4.2
```
...
```bash
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2024.4.2 --set replicaCount=1
```
...
```bash
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2024.4.2 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/inbox-ui --version=v2024.5.3
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2024.5.3
```
...
```bash
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2024.5.3 --set replicaCount=1
```
...
```bash
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2024.5.3 --values values.yaml
```

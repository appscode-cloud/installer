...
$ helm repo update
$ helm search repo appscode/inbox-ui --version=v2025.5.16
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2025.5.16
```
...
```bash
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2025.5.16 --set replicaCount=1
```
...
```bash
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2025.5.16 --values values.yaml
```

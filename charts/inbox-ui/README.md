...
$ helm repo update
$ helm search repo appscode/inbox-ui --version=v2026.7.10
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2026.7.10
```
...
```bash
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2026.7.10 --set replicaCount=1
```
...
```bash
$ helm upgrade -i inbox-ui appscode/inbox-ui -n ace --create-namespace --version=v2026.7.10 --values values.yaml
```

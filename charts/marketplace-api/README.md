...
$ helm repo update
$ helm search repo appscode/marketplace-api --version=v2025.4.30
$ helm upgrade -i marketplace-api appscode/marketplace-api -n ace --create-namespace --version=v2025.4.30
```
...
```bash
$ helm upgrade -i marketplace-api appscode/marketplace-api -n ace --create-namespace --version=v2025.4.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i marketplace-api appscode/marketplace-api -n ace --create-namespace --version=v2025.4.30 --values values.yaml
```

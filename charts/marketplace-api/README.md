...
$ helm repo update
$ helm search repo appscode/marketplace-api --version=v2025.1.17
$ helm upgrade -i marketplace-api appscode/marketplace-api -n ace --create-namespace --version=v2025.1.17
```
...
| spreadsheet.credentials                    |                                                                                                                                      | <code>""</code>                                                                                                                                |


Specify each parameter using the `--set key=value[,key=value]` argument to `helm upgrade -i`. For example:

```bash
$ helm upgrade -i marketplace-api appscode/marketplace-api -n ace --create-namespace --version=v2025.1.17 --set replicaCount=1
```
...
```bash
$ helm upgrade -i marketplace-api appscode/marketplace-api -n ace --create-namespace --version=v2025.1.17 --values values.yaml
```

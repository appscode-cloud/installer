...
$ helm repo update
$ helm search repo appscode/cluster-presets --version=v2024.9.30
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2024.9.30
```
...
```bash
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2024.9.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2024.9.30 --values values.yaml
```

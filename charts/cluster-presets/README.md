...
$ helm repo update
$ helm search repo appscode/cluster-presets --version=v2025.9.15
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2025.9.15
```
...
```bash
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2025.9.15 --set replicaCount=1
```
...
```bash
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2025.9.15 --values values.yaml
```

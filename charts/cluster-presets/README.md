...
$ helm repo update
$ helm search repo appscode/cluster-presets --version=v2024.8.21
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2024.8.21
```
...
```bash
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2024.8.21 --set replicaCount=1
```
...
```bash
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2024.8.21 --values values.yaml
```

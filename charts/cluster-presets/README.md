...
$ helm repo update
$ helm search repo appscode/cluster-presets --version=v2026.3.30
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2026.3.30
```
...
```bash
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2026.3.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2026.3.30 --values values.yaml
```

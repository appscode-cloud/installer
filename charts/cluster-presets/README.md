...
$ helm repo update
$ helm search repo appscode/cluster-presets --version=v2024.7.4
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2024.7.4
```
...
```bash
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2024.7.4 --set replicaCount=1
```
...
```bash
$ helm upgrade -i cluster-presets appscode/cluster-presets -n ace --create-namespace --version=v2024.7.4 --values values.yaml
```

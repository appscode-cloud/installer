...
$ helm repo update
$ helm search repo appscode/service-gateway --version=v2026.4.30
$ helm upgrade -i service-gateway appscode/service-gateway -n ace --create-namespace --version=v2026.4.30
```
...
```bash
$ helm upgrade -i service-gateway appscode/service-gateway -n ace --create-namespace --version=v2026.4.30 --set clusterMetadata.uid=tbd
```
...
```bash
$ helm upgrade -i service-gateway appscode/service-gateway -n ace --create-namespace --version=v2026.4.30 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/service-gateway --version=v2024.12.9
$ helm upgrade -i service-gateway appscode/service-gateway -n ace --create-namespace --version=v2024.12.9
```
...
```bash
$ helm upgrade -i service-gateway appscode/service-gateway -n ace --create-namespace --version=v2024.12.9 --set clusterMetadata.uid=tbd
```
...
```bash
$ helm upgrade -i service-gateway appscode/service-gateway -n ace --create-namespace --version=v2024.12.9 --values values.yaml
```

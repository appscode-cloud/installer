...
$ helm repo update
$ helm search repo appscode/service-gateway --version=v2026.3.30
$ helm upgrade -i service-gateway appscode/service-gateway -n ace --create-namespace --version=v2026.3.30
```
...
| envoy.tag                                          |                                                                    | <code>"v1.36.4-ac"</code>                                                                                                                                                                                         |
...
```bash
$ helm upgrade -i service-gateway appscode/service-gateway -n ace --create-namespace --version=v2026.3.30 --set clusterMetadata.uid=tbd
```
...
```bash
$ helm upgrade -i service-gateway appscode/service-gateway -n ace --create-namespace --version=v2026.3.30 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/service-gateway --version=v2026.9.11
$ helm upgrade -i service-gateway appscode/service-gateway -n ace --create-namespace --version=v2026.9.11
```
...
```bash
$ helm upgrade -i service-gateway appscode/service-gateway -n ace --create-namespace --version=v2026.9.11 --set clusterMetadata.uid=tbd
```
...
```bash
$ helm upgrade -i service-gateway appscode/service-gateway -n ace --create-namespace --version=v2026.9.11 --values values.yaml
```

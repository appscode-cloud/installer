...
$ helm repo update
$ helm search repo appscode/service-gateway-presets --version=v2024.9.30
$ helm upgrade -i service-gateway-presets appscode/service-gateway-presets -n ace --create-namespace --version=v2024.9.30
```
...
```bash
$ helm upgrade -i service-gateway-presets appscode/service-gateway-presets -n ace --create-namespace --version=v2024.9.30 --set infra.clusterName="c1"
```
...
```bash
$ helm upgrade -i service-gateway-presets appscode/service-gateway-presets -n ace --create-namespace --version=v2024.9.30 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/service-gateway-presets --version=v2026.5.22
$ helm upgrade -i service-gateway-presets appscode/service-gateway-presets -n ace --create-namespace --version=v2026.5.22
```
...
| chart.version                                      |                                                                | <code>"v2026.5.22"</code>                                                                                                                                                                                         |
...
```bash
$ helm upgrade -i service-gateway-presets appscode/service-gateway-presets -n ace --create-namespace --version=v2026.5.22 --set infra.host=chart-example.local
```
...
```bash
$ helm upgrade -i service-gateway-presets appscode/service-gateway-presets -n ace --create-namespace --version=v2026.5.22 --values values.yaml
```

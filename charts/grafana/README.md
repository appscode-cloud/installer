...
$ helm repo update
$ helm search repo appscode/grafana --version=v2022.06.14
$ helm upgrade -i grafana appscode/grafana -n ace-system --create-namespace --version=v2022.06.14
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace-system --create-namespace --version=v2022.06.14 --set replicaCount=1
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace-system --create-namespace --version=v2022.06.14 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/grafana --version=v2024.7.7
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2024.7.7
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2024.7.7 --set replicaCount=1
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2024.7.7 --values values.yaml
```

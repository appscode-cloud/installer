...
$ helm repo update
$ helm search repo appscode/grafana --version=v2024.10.31
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2024.10.31
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2024.10.31 --set replicaCount=1
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2024.10.31 --values values.yaml
```

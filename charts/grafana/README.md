...
$ helm repo update
$ helm search repo appscode/grafana --version=v2023.03.23
$ helm upgrade -i grafana appscode/grafana -n ace-system --create-namespace --version=v2023.03.23
```
...
```bash
$ helm uninstall grafana -n ace-system
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace-system --create-namespace --version=v2023.03.23 --set replicaCount=1
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace-system --create-namespace --version=v2023.03.23 --values values.yaml
```

...
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2023.10.1
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2023.10.1 --set replicaCount=1
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2023.10.1 --values values.yaml
```

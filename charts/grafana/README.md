...
$ helm repo update
$ helm search repo appscode/grafana --version=v2023.11.14
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2023.11.14
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2023.11.14 --set replicaCount=1
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2023.11.14 --values values.yaml
```

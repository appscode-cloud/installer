...
$ helm repo update
$ helm search repo appscode/grafana --version=v2023.10.18
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2023.10.18
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2023.10.18 --set replicaCount=1
```
...
```bash
$ helm upgrade -i grafana appscode/grafana -n ace --create-namespace --version=v2023.10.18 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/capa-vpc-peering-operator --version=v2023.10.1
$ helm upgrade -i capa-vpc-peering-operator appscode/capa-vpc-peering-operator -n kubeops --create-namespace --version=v2023.10.1
```
...
```bash
$ helm upgrade -i capa-vpc-peering-operator appscode/capa-vpc-peering-operator -n kubeops --create-namespace --version=v2023.10.1 --set replicaCount=1
```
...
```bash
$ helm upgrade -i capa-vpc-peering-operator appscode/capa-vpc-peering-operator -n kubeops --create-namespace --version=v2023.10.1 --values values.yaml
```

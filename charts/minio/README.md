...
$ helm repo update
$ helm search repo appscode/minio --version=v2026.7.10
$ helm upgrade -i minio appscode/minio -n ace --create-namespace --version=v2026.7.10
```
...
```bash
$ helm upgrade -i minio appscode/minio -n ace --create-namespace --version=v2026.7.10 --set replicaCount=1
```
...
```bash
$ helm upgrade -i minio appscode/minio -n ace --create-namespace --version=v2026.7.10 --values values.yaml
```

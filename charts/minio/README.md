...
$ helm repo update
$ helm search repo appscode/minio --version=v2026.5.22
$ helm upgrade -i minio appscode/minio -n ace --create-namespace --version=v2026.5.22
```
...
```bash
$ helm upgrade -i minio appscode/minio -n ace --create-namespace --version=v2026.5.22 --set replicaCount=1
```
...
```bash
$ helm upgrade -i minio appscode/minio -n ace --create-namespace --version=v2026.5.22 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/minio --version=v2026.9.11
$ helm upgrade -i minio appscode/minio -n ace --create-namespace --version=v2026.9.11
```
...
```bash
$ helm upgrade -i minio appscode/minio -n ace --create-namespace --version=v2026.9.11 --set replicaCount=1
```
...
```bash
$ helm upgrade -i minio appscode/minio -n ace --create-namespace --version=v2026.9.11 --values values.yaml
```

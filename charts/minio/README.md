...
$ helm repo update
$ helm search repo appscode/minio --version=v2025.8.15
$ helm upgrade -i minio appscode/minio -n ace --create-namespace --version=v2025.8.15
```
...
```bash
$ helm upgrade -i minio appscode/minio -n ace --create-namespace --version=v2025.8.15 --set replicaCount=1
```
...
```bash
$ helm upgrade -i minio appscode/minio -n ace --create-namespace --version=v2025.8.15 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/platform-ui --version=v2023.10.1
$ helm upgrade -i platform-ui appscode/platform-ui -n ace-system --create-namespace --version=v2023.10.1
```
...
```bash
$ helm upgrade -i platform-ui appscode/platform-ui -n ace-system --create-namespace --version=v2023.10.1 --set replicaCount=1
```
...
```bash
$ helm upgrade -i platform-ui appscode/platform-ui -n ace-system --create-namespace --version=v2023.10.1 --values values.yaml
```

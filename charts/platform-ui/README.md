...
$ helm repo update
$ helm search repo appscode/platform-ui --version=v2026.4.30
$ helm upgrade -i platform-ui appscode/platform-ui -n ace --create-namespace --version=v2026.4.30
```
...
```bash
$ helm upgrade -i platform-ui appscode/platform-ui -n ace --create-namespace --version=v2026.4.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i platform-ui appscode/platform-ui -n ace --create-namespace --version=v2026.4.30 --values values.yaml
```

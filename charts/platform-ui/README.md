...
$ helm repo update
$ helm search repo appscode/platform-ui --version=v2024.7.4
$ helm upgrade -i platform-ui appscode/platform-ui -n ace --create-namespace --version=v2024.7.4
```
...
```bash
$ helm upgrade -i platform-ui appscode/platform-ui -n ace --create-namespace --version=v2024.7.4 --set replicaCount=1
```
...
```bash
$ helm upgrade -i platform-ui appscode/platform-ui -n ace --create-namespace --version=v2024.7.4 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/platform-ui --version=v2025.2.28
$ helm upgrade -i platform-ui appscode/platform-ui -n ace --create-namespace --version=v2025.2.28
```
...
```bash
$ helm upgrade -i platform-ui appscode/platform-ui -n ace --create-namespace --version=v2025.2.28 --set replicaCount=1
```
...
```bash
$ helm upgrade -i platform-ui appscode/platform-ui -n ace --create-namespace --version=v2025.2.28 --values values.yaml
```

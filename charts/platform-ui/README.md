...
$ helm repo update
$ helm search repo appscode/platform-ui --version=v2026.6.12
$ helm upgrade -i platform-ui appscode/platform-ui -n ace --create-namespace --version=v2026.6.12
```
...
```bash
$ helm upgrade -i platform-ui appscode/platform-ui -n ace --create-namespace --version=v2026.6.12 --set replicaCount=1
```
...
```bash
$ helm upgrade -i platform-ui appscode/platform-ui -n ace --create-namespace --version=v2026.6.12 --values values.yaml
```

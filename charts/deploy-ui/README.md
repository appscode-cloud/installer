...
$ helm repo update
$ helm search repo appscode/deploy-ui --version=v2024.11.18
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2024.11.18
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2024.11.18 --set replicaCount=1
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2024.11.18 --values values.yaml
```

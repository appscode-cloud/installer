...
$ helm repo update
$ helm search repo appscode/deploy-ui --version=v2025.12.15
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.12.15
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.12.15 --set replicaCount=1
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.12.15 --values values.yaml
```

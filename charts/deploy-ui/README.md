...
$ helm repo update
$ helm search repo appscode/deploy-ui --version=v2026.7.10
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2026.7.10
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2026.7.10 --set replicaCount=1
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2026.7.10 --values values.yaml
```

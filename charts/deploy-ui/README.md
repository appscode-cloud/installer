...
$ helm repo update
$ helm search repo appscode/deploy-ui --version=v2025.10.17
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.10.17
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.10.17 --set replicaCount=1
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.10.17 --values values.yaml
```

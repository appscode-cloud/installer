...
$ helm repo update
$ helm search repo appscode/deploy-ui --version=v2025.7.31
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.7.31
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.7.31 --set replicaCount=1
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.7.31 --values values.yaml
```

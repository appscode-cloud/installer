...
$ helm repo update
$ helm search repo appscode/deploy-ui --version=v2024.10.7
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2024.10.7
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2024.10.7 --set replicaCount=1
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2024.10.7 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/deploy-ui --version=v2025.6.16
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.6.16
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.6.16 --set replicaCount=1
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.6.16 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/deploy-ui --version=v2025.3.14
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.3.14
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.3.14 --set replicaCount=1
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.3.14 --values values.yaml
```

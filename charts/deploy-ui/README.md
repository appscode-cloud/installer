...
$ helm repo update
$ helm search repo appscode/deploy-ui --version=v2026.5.22
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2026.5.22
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2026.5.22 --set replicaCount=1
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2026.5.22 --values values.yaml
```

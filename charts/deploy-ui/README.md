...
$ helm repo update
$ helm search repo appscode/deploy-ui --version=v2025.6.30
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.6.30
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.6.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i deploy-ui appscode/deploy-ui -n ace --create-namespace --version=v2025.6.30 --values values.yaml
```

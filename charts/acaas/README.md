...
$ helm repo update
$ helm search repo appscode/acaas --version=v2025.12.15
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2025.12.15
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2025.12.15 --set global.nameOverride="ace"
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2025.12.15 --values values.yaml
```

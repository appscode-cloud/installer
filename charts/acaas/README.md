...
$ helm repo update
$ helm search repo appscode/acaas --version=v2026.6.12
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.6.12
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.6.12 --set global.nameOverride="ace"
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.6.12 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/acaas --version=v2026.6.19
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.6.19
```
...
| global.platform.offlineInstaller                |                                                                                                                                      | <code>false</code>                           |
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.6.19 --set global.nameOverride="ace"
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.6.19 --values values.yaml
```

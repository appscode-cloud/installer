...
$ helm repo update
$ helm search repo appscode/acaas --version=v2026.9.11
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.9.11
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.9.11 --set global.nameOverride="ace"
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.9.11 --values values.yaml
```

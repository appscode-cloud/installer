...
$ helm repo update
$ helm search repo appscode/acaas --version=v2025.9.30
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2025.9.30
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2025.9.30 --set global.nameOverride="ace"
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2025.9.30 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/acaas --version=v2025.6.16
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2025.6.16
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2025.6.16 --set global.nameOverride="ace"
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2025.6.16 --values values.yaml
```

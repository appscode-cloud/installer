...
$ helm repo update
$ helm search repo appscode/acaas --version=v2026.5.22
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.5.22
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.5.22 --set global.nameOverride="ace"
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.5.22 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/acaas --version=v2026.7.10
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.7.10
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.7.10 --set global.nameOverride="ace"
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2026.7.10 --values values.yaml
```

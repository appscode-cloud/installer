...
$ helm repo update
$ helm search repo appscode/acaas --version=v2025.3.14
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2025.3.14
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2025.3.14 --set global.nameOverride="ace"
```
...
```bash
$ helm upgrade -i ace appscode/acaas -n ace --create-namespace --version=v2025.3.14 --values values.yaml
```

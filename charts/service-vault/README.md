...
$ helm repo update
$ helm search repo appscode/service-vault --version=v2025.12.15
$ helm upgrade -i service-vault appscode/service-vault -n ace --create-namespace --version=v2025.12.15
```
...
```bash
$ helm upgrade -i service-vault appscode/service-vault -n ace --create-namespace --version=v2025.12.15 --set infra.host=chart-example.local
```
...
```bash
$ helm upgrade -i service-vault appscode/service-vault -n ace --create-namespace --version=v2025.12.15 --values values.yaml
```

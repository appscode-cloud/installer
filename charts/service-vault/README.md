...
$ helm repo update
$ helm search repo appscode/service-vault --version=v2025.10.17
$ helm upgrade -i service-vault appscode/service-vault -n ace --create-namespace --version=v2025.10.17
```
...
```bash
$ helm upgrade -i service-vault appscode/service-vault -n ace --create-namespace --version=v2025.10.17 --set infra.host=chart-example.local
```
...
```bash
$ helm upgrade -i service-vault appscode/service-vault -n ace --create-namespace --version=v2025.10.17 --values values.yaml
```

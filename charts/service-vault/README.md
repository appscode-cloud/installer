...
$ helm repo update
$ helm search repo appscode/service-vault --version=v2026.4.30
$ helm upgrade -i service-vault appscode/service-vault -n ace --create-namespace --version=v2026.4.30
```
...
```bash
$ helm upgrade -i service-vault appscode/service-vault -n ace --create-namespace --version=v2026.4.30 --set infra.host=chart-example.local
```
...
```bash
$ helm upgrade -i service-vault appscode/service-vault -n ace --create-namespace --version=v2026.4.30 --values values.yaml
```

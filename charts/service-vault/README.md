...
$ helm repo update
$ helm search repo appscode/service-vault --version=v2026.5.22
$ helm upgrade -i service-vault appscode/service-vault -n ace --create-namespace --version=v2026.5.22
```
...
```bash
$ helm upgrade -i service-vault appscode/service-vault -n ace --create-namespace --version=v2026.5.22 --set infra.host=chart-example.local
```
...
```bash
$ helm upgrade -i service-vault appscode/service-vault -n ace --create-namespace --version=v2026.5.22 --values values.yaml
```

...
Common labels
*/}}
{{- define "prom-proxy.labels" -}}
helm.sh/chart: {{ include "prom-proxy.chart" . }}
{{ include "prom-proxy.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "prom-proxy.selectorLabels" -}}
app.kubernetes.io/name: {{ include "prom-proxy.name" . }}

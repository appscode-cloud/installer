...
$ helm repo update
$ helm search repo appscode/cluster-ui --version=v2024.11.18
$ helm upgrade -i cluster-ui appscode/cluster-ui -n ace --create-namespace --version=v2024.11.18
```
...
```bash
$ helm upgrade -i cluster-ui appscode/cluster-ui -n ace --create-namespace --version=v2024.11.18 --set replicaCount=1
```
...
```bash
$ helm upgrade -i cluster-ui appscode/cluster-ui -n ace --create-namespace --version=v2024.11.18 --values values.yaml
```

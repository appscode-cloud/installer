...
$ helm upgrade -i cluster-ui appscode/cluster-ui -n ace-system --create-namespace --version=0.1.0
```
...
```bash
$ helm upgrade -i cluster-ui appscode/cluster-ui -n ace-system --create-namespace --version=0.1.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i cluster-ui appscode/cluster-ui -n ace-system --create-namespace --version=0.1.0 --values values.yaml
```

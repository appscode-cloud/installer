...
$ helm repo update
$ helm search repo appscode/cluster-ui --version=v2025.7.16
$ helm upgrade -i cluster-ui appscode/cluster-ui -n ace --create-namespace --version=v2025.7.16
```
...
```bash
$ helm upgrade -i cluster-ui appscode/cluster-ui -n ace --create-namespace --version=v2025.7.16 --set replicaCount=1
```
...
```bash
$ helm upgrade -i cluster-ui appscode/cluster-ui -n ace --create-namespace --version=v2025.7.16 --values values.yaml
```

...
$ helm upgrade -i platform-api appscode/platform-api -n kubeops --create-namespace --version=0.1.0
```
...
```bash
$ helm uninstall platform-api -n kubeops
```
...
```bash
$ helm upgrade -i platform-api appscode/platform-api -n kubeops --create-namespace --version=0.1.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i platform-api appscode/platform-api -n kubeops --create-namespace --version=0.1.0 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2024.10.24
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.10.24
```
...
| helm.releases.catalog-manager.version                       |                                 | <code>"v2024.10.24"</code>                 |
...
| helm.releases.cluster-presets.version                       |                                 | <code>"v2024.10.24"</code>                 |
...
| helm.releases.grafana-operator.version                      |                                 | <code>"v2024.11.8"</code>                  |
...
| helm.releases.kubedb-ui-presets.version                     |                                 | <code>"v2024.10.24"</code>                 |
| helm.releases.kube-ui-server.version                        |                                 | <code>"v2024.10.24"</code>                 |
...
| helm.releases.monitoring-operator.version                   |                                 | <code>"v2024.11.8"</code>                  |
...
| helm.releases.service-backend.version                       |                                 | <code>"v2024.10.24"</code>                 |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.10.24 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.10.24 --values values.yaml
```

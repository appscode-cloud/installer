...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2024.10.7
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.10.7
```
...
| helm.releases.catalog-manager.version                       |                                 | <code>"v2024.10.7"</code>                  |
...
| helm.releases.cluster-presets.version                       |                                 | <code>"v2024.10.7"</code>                  |
...
| helm.releases.kubedb-ui-presets.version                     |                                 | <code>"v2024.10.7"</code>                  |
| helm.releases.kube-ui-server.version                        |                                 | <code>"v2024.10.7"</code>                  |
...
| helm.releases.service-backend.version                       |                                 | <code>"v2024.10.7"</code>                  |
| helm.releases.service-gateway-presets.version               |                                 | <code>"v2024.10.7"</code>                  |
| helm.releases.service-provider.version                      |                                 | <code>"v2024.10.7"</code>                  |
...
| helm.releases.stash-presets.version                         |                                 | <code>"v2024.10.7"</code>                  |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.10.7 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.10.7 --values values.yaml
```

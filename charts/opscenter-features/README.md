...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2024.12.9
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.12.9
```
...
| helm.releases.kubedb-ui-presets.version                     |                                 | <code>"v2024.12.9"</code>                  |
...
| helm.releases.service-backend.version                       |                                 | <code>"v2024.12.9"</code>                  |
| helm.releases.service-gateway.version                       |                                 | <code>"v2024.12.9"</code>                  |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.12.9 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.12.9 --values values.yaml
```

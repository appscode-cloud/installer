...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2024.9.30
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.9.30
```
...
| helm.releases.catalog-manager.version                       |                                 | <code>"v2024.9.30"</code>                  |
...
| helm.releases.cluster-presets.version                       |                                 | <code>"v2024.9.30"</code>                  |
...
| helm.releases.grafana-operator.version                      |                                 | <code>"v2024.9.30"</code>                  |
...
| helm.releases.kubedb-ui-presets.version                     |                                 | <code>"v2024.9.30"</code>                  |
| helm.releases.kube-ui-server.version                        |                                 | <code>"v2024.9.30"</code>                  |
| helm.releases.kubedb.version                                |                                 | <code>"v2024.9.30"</code>                  |
| helm.releases.kubedb-opscenter.version                      |                                 | <code>"v2024.9.30"</code>                  |
...
| helm.releases.kubevault.version                             |                                 | <code>"v2024.9.30"</code>                  |
...
| helm.releases.opscenter-features.version                    |                                 | <code>"v2024.9.30"</code>                  |
...
| helm.releases.service-backend.version                       |                                 | <code>"v2024.9.30"</code>                  |
| helm.releases.service-gateway-presets.version               |                                 | <code>"v2024.9.30"</code>                  |
| helm.releases.service-provider.version                      |                                 | <code>"v2024.9.30"</code>                  |
| helm.releases.sidekick.version                              |                                 | <code>"v2024.9.30"</code>                  |
...
| helm.releases.stash-presets.version                         |                                 | <code>"v2024.9.30"</code>                  |
...
| helm.releases.ace-ocm-addons.version                        |                                 | <code>"v2024.9.30"</code>                  |
| helm.releases.ingress-nginx.version                         |                                 | <code>"4.11.1"</code>                      |
| helm.releases.cluster-manager-hub.version                   |                                 | <code>"v2024.7.10"</code>                  |
...
| helm.releases.cluster-auth-manager.version                  |                                 | <code>"v2024.8.9"</code>                   |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.9.30 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.9.30 --values values.yaml
```

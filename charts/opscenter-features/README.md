...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2026.7.10
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2026.7.10
```
...
| helm.releases.aceshifter.version                                        |                                 | <code>"v2026.7.10"</code>                  |
...
| helm.releases.catalog-manager.version                                   |                                 | <code>"v2026.7.10"</code>                  |
...
| helm.releases.cluster-presets.version                                   |                                 | <code>"v2026.7.10"</code>                  |
...
| helm.releases.opscenter-features.version                                |                                 | <code>"v2026.7.10"</code>                  |
...
| helm.releases.service-backend.version                                   |                                 | <code>"v2026.7.10"</code>                  |
...
| helm.releases.snapshot-controller.version                               |                                 | <code>"5.2.0"</code>                       |
| helm.releases.stash.version                                             |                                 | <code>"v2025.7.31"</code>                  |
| helm.releases.stash-opscenter.version                                   |                                 | <code>"v2025.7.31"</code>                  |
| helm.releases.stash-presets.version                                     |                                 | <code>"v2026.7.10"</code>                  |
...
| helm.releases.inbox-ui.version                                          |                                 | <code>"v2026.7.10"</code>                  |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2026.7.10 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2026.7.10 --values values.yaml
```

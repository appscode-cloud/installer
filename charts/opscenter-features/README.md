...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2024.10.17
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.10.17
```
...
| helm.releases.catalog-manager.version                       |                                 | <code>"v2024.10.17"</code>                 |
...
| helm.releases.cluster-presets.version                       |                                 | <code>"v2024.10.17"</code>                 |
...
| helm.releases.kubedb-ui-presets.version                     |                                 | <code>"v2024.10.17"</code>                 |
...
| helm.releases.service-backend.version                       |                                 | <code>"v2024.10.17"</code>                 |
| helm.releases.service-gateway-presets.version               |                                 | <code>"v2024.10.17"</code>                 |
| helm.releases.service-provider.version                      |                                 | <code>"v2024.10.17"</code>                 |
...
| helm.releases.stash-presets.version                         |                                 | <code>"v2024.10.17"</code>                 |
...
| helm.releases.cluster-profile-manager.version               |                                 | <code>"v2024.10.17"</code>                 |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.10.17 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.10.17 --values values.yaml
```

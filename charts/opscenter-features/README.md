...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2024.8.21
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.8.21
```
...
| helm.releases.cluster-presets.version                       |                                 | <code>"v2024.8.21"</code>                  |
...
| helm.releases.kubedb-ui-presets.version                     |                                 | <code>"v2024.8.21"</code>                  |
| helm.releases.kube-ui-server.version                        |                                 | <code>"v2024.8.21"</code>                  |
| helm.releases.kubedb.version                                |                                 | <code>"v2024.8.21"</code>                  |
| helm.releases.kubedb-opscenter.version                      |                                 | <code>"v2024.8.21"</code>                  |
...
| helm.releases.kubestash.version                             |                                 | <code>"v2024.8.30"</code>                  |
...
| helm.releases.panopticon.version                            |                                 | <code>"v2024.8.21"</code>                  |
...
| helm.releases.scanner.version                               |                                 | <code>"v2024.8.21"</code>                  |
...
| helm.releases.stash.version                                 |                                 | <code>"v2024.8.27"</code>                  |
| helm.releases.stash-opscenter.version                       |                                 | <code>"v2024.8.27"</code>                  |
| helm.releases.stash-presets.version                         |                                 | <code>"v2024.8.21"</code>                  |
| helm.releases.supervisor.version                            |                                 | <code>"v2024.8.21"</code>                  |
...
| helm.releases.cluster-gateway-manager.version               |                                 | <code>"v2024.7.10"</code>                  |
...
| helm.releases.license-proxyserver-manager.version           |                                 | <code>"v2024.9.13"</code>                  |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.8.21 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.8.21 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2025.10.31
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2025.10.31
```
...
| helm.releases.aceshifter.version                                        |                                 | <code>"v2025.10.31"</code>                 |
...
| helm.releases.catalog-manager.version                                   |                                 | <code>"v2025.10.31"</code>                 |
| helm.releases.cert-manager.version                                      |                                 | <code>"v1.18.2"</code>                     |
| helm.releases.cert-manager-csi-driver-cacerts.version                   |                                 | <code>"v2025.10.31"</code>                 |
| helm.releases.cluster-autoscaler.version                                |                                 | <code>"9.29.0"</code>                      |
| helm.releases.cluster-presets.version                                   |                                 | <code>"v2025.10.31"</code>                 |
...
| helm.releases.external-dns-operator.version                             |                                 | <code>"v2025.9.30"</code>                  |
...
| helm.releases.kubedb-ui-presets.version                                 |                                 | <code>"v2025.10.31"</code>                 |
| helm.releases.kube-ui-server.version                                    |                                 | <code>"v2025.10.31"</code>                 |
| helm.releases.kubedb.version                                            |                                 | <code>"v2025.10.17"</code>                 |
| helm.releases.kubedb-opscenter.version                                  |                                 | <code>"v2025.10.17"</code>                 |
...
| helm.releases.kubestash.version                                         |                                 | <code>"v2025.10.17"</code>                 |
...
| helm.releases.opscenter-features.version                                |                                 | <code>"v2025.10.31"</code>                 |
...
| helm.releases.service-backend.version                                   |                                 | <code>"v2025.10.31"</code>                 |
| helm.releases.service-gateway.version                                   |                                 | <code>"v2025.10.31"</code>                 |
| helm.releases.service-gateway-presets.version                           |                                 | <code>"v2025.10.31"</code>                 |
| helm.releases.service-provider.version                                  |                                 | <code>"v2025.10.31"</code>                 |
...
| helm.releases.stash-presets.version                                     |                                 | <code>"v2025.10.31"</code>                 |
...
| helm.releases.inbox-ui.version                                          |                                 | <code>"v2025.10.31"</code>                 |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2025.10.31 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2025.10.31 --values values.yaml
```

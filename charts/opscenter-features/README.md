...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2025.1.17
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2025.1.17
```
...
| helm.releases.catalog-manager.version                       |                                 | <code>"v2025.1.17"</code>                  |
...
| helm.releases.cluster-presets.version                       |                                 | <code>"v2025.1.17"</code>                  |
...
| helm.releases.opentelemetry-kube-stack.version              |                                 | <code>"0.107.0"</code>                     |
...
| helm.releases.kubedb-opscenter.version                      |                                 | <code>"v2025.1.9"</code>                   |
...
| helm.releases.service-backend.version                       |                                 | <code>"v2025.1.17"</code>                  |
| helm.releases.service-gateway.version                       |                                 | <code>"v2025.1.17"</code>                  |
| helm.releases.service-gateway-presets.version               |                                 | <code>"v2025.1.17"</code>                  |
| helm.releases.service-provider.version                      |                                 | <code>"v2025.1.17"</code>                  |
| helm.releases.sidekick.version                              |                                 | <code>"v2024.11.8"</code>                  |
| helm.releases.snapshot-controller.version                   |                                 | <code>"3.0.6"</code>                       |
| helm.releases.stash.version                                 |                                 | <code>"v2025.1.9"</code>                   |
| helm.releases.stash-opscenter.version                       |                                 | <code>"v2025.1.9"</code>                   |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2025.1.17 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2025.1.17 --values values.yaml
```

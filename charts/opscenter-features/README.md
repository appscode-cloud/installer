...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2024.6.28
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.6.28
```
...
| helm.releases.cluster-presets.version                       |                                 | <code>"v2024.6.28"</code>                  |
...
| helm.releases.kube-ui-server.version                        |                                 | <code>"v2024.6.28"</code>                  |
...
| helm.releases.license-proxyserver.version                   |                                 | <code>"v2024.6.28"</code>                  |
...
| helm.releases.stash-presets.version                         |                                 | <code>"v2024.6.28"</code>                  |
...
| helm.releases.ace-ocm-addons.version                        |                                 | <code>"v2024.6.28"</code>                  |
...
| helm.releases.license-proxyserver-manager.version           |                                 | <code>"v2024.6.28"</code>                  |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.6.28 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.6.28 --values values.yaml
```

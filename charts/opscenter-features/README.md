...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2024.4.2
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.4.2
```
...
| helm.releases.stash.version                                 |                         | <code>"v2024.4.2"</code>                   |
| helm.releases.stash-opscenter.version                       |                         | <code>"v2024.4.2"</code>                   |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.4.2 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.4.2 --values values.yaml
```

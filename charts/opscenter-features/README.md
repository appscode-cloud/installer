...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2025.6.30
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2025.6.30
```
...
| helm.releases.catalog-manager.version                                   |                                 | <code>"v2025.6.30"</code>                  |
...
| helm.releases.cluster-presets.version                                   |                                 | <code>"v2025.6.30"</code>                  |
...
| helm.releases.kubedb-ui-presets.version                                 |                                 | <code>"v2025.6.30"</code>                  |
...
| helm.releases.service-backend.version                                   |                                 | <code>"v2025.6.30"</code>                  |
| helm.releases.service-gateway.version                                   |                                 | <code>"v2025.6.30"</code>                  |
| helm.releases.service-gateway-presets.version                           |                                 | <code>"v2025.6.30"</code>                  |
...
| helm.releases.inbox-ui.version                                          |                                 | <code>"v2025.6.30"</code>                  |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2025.6.30 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2025.6.30 --values values.yaml
```

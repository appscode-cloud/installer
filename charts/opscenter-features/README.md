...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2026.3.30
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2026.3.30
```
...
| helm.releases.aceshifter.version                                        |                                 | <code>"v2026.3.30"</code>                                    |
...
| helm.releases.catalog-manager.version                                   |                                 | <code>"v2026.3.30"</code>                                    |
...
| helm.releases.cluster-presets.version                                   |                                 | <code>"v2026.3.30"</code>                                    |
...
| helm.releases.kubedb-ui-presets.version                                 |                                 | <code>"v2026.3.30"</code>                                    |
| helm.releases.kube-ui-server.version                                    |                                 | <code>"v2026.3.30"</code>                                    |
| helm.releases.kubedb.version                                            |                                 | <code>"v2026.2.26"</code>                                    |
| helm.releases.kubedb-opscenter.version                                  |                                 | <code>"v2026.2.26"</code>                                    |
...
| helm.releases.kubestash.version                                         |                                 | <code>"v2026.2.26"</code>                                    |
...
| helm.releases.opscenter-features.version                                |                                 | <code>"v2026.3.30"</code>                                    |
...
| helm.releases.service-backend.version                                   |                                 | <code>"v2026.3.30"</code>                                    |
| helm.releases.service-gateway.version                                   |                                 | <code>"v2026.3.30"</code>                                    |
| helm.releases.service-gateway-presets.version                           |                                 | <code>"v2026.3.30"</code>                                    |
| helm.releases.service-provider.version                                  |                                 | <code>"v2026.3.30"</code>                                    |
...
| alertmanagerConfigSelector.labelKey                                     |                                 | <code>monitoring.appscode.com/alertmanager-config-set</code> |
| alertmanagerConfigSelector.labelValue                                   |                                 | <code>core</code>                                            |
| notifications.email.enabled                                             |                                 | <code>false</code>                                           |
| notifications.email.continue                                            |                                 | <code>true</code>                                            |
| notifications.email.to                                                  |                                 | <code>""</code>                                              |
| notifications.email.from                                                |                                 | <code>""</code>                                              |
| notifications.email.smarthost                                           |                                 | <code>""</code>                                              |
| notifications.email.authUsername                                        |                                 | <code>""</code>                                              |
| notifications.email.authSecretName                                      |                                 | <code>""</code>                                              |
| notifications.email.authSecretKey                                       |                                 | <code>""</code>                                              |
| notifications.email.authPassword                                        |                                 | <code>""</code>                                              |
| notifications.email.requireTLS                                          |                                 | <code>true</code>                                            |
| notifications.email.sendResolved                                        |                                 | <code>true</code>                                            |
| notifications.webhook.enabled                                           |                                 | <code>false</code>                                           |
| notifications.webhook.continue                                          |                                 | <code>true</code>                                            |
| notifications.webhook.urlSecretName                                     |                                 | <code>""</code>                                              |
| notifications.webhook.urlSecretKey                                      |                                 | <code>""</code>                                              |
| notifications.webhook.url                                               |                                 | <code>""</code>                                              |
| notifications.webhook.sendResolved                                      |                                 | <code>true</code>                                            |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2026.3.30 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2026.3.30 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2024.7.2
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.7.2
```
...
| helm.releases.cluster-presets.version                       |                                 | <code>"v2024.7.2"</code>                   |
...
| helm.releases.kubedb-ui-presets.version                     |                                 | <code>"v2024.7.2"</code>                   |
...
| helm.releases.license-proxyserver.version                   |                                 | <code>"v2024.7.2"</code>                   |
...
| helm.releases.opscenter-features.version                    |                                 | <code>"v2024.7.2"</code>                   |
...
| helm.releases.stash-presets.version                         |                                 | <code>"v2024.7.2"</code>                   |
...
| helm.releases.ace-ocm-addons.version                        |                                 | <code>"v2024.7.2"</code>                   |
...
| helm.releases.license-proxyserver-manager.version           |                                 | <code>"v2024.7.2"</code>                   |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.7.2 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.7.2 --values values.yaml
```

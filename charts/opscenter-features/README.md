...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2024.6.18
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.6.18
```
...
| helm.releases.kubedb-ui-presets.version                     |                                 | <code>"v2024.6.18"</code>                  |
...
| helm.releases.ace-ocm-addons.version                        |                                 | <code>"v2024.6.18"</code>                  |
...
| helm.releases.license-proxyserver-manager.version           |                                 | <code>"v2024.6.18"</code>                  |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.6.18 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2024.6.18 --values values.yaml
```

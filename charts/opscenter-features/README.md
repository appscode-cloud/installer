...
$ helm repo update
$ helm search repo appscode/opscenter-features --version=v2025.4.30
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2025.4.30
```
...
| helm.releases.aceshifter.version                                        |                                 | <code>"v2025.4.30"</code>                  |
| helm.releases.appscode-otel-stack.version                               |                                 | <code>"v2025.2.28"</code>                  |
| helm.releases.aws-credential-manager.version                            |                                 | <code>"v2025.3.14"</code>                  |
...
| helm.releases.catalog-manager.version                                   |                                 | <code>"v2025.4.30"</code>                  |
| helm.releases.cert-manager.version                                      |                                 | <code>"v1.17.1"</code>                     |
...
| helm.releases.cluster-presets.version                                   |                                 | <code>"v2025.4.30"</code>                  |
...
| helm.releases.kubedb-ui-presets.version                                 |                                 | <code>"v2025.4.30"</code>                  |
| helm.releases.kube-ui-server.version                                    |                                 | <code>"v2025.4.30"</code>                  |
| helm.releases.kubedb.version                                            |                                 | <code>"v2025.3.24"</code>                  |
| helm.releases.kubedb-opscenter.version                                  |                                 | <code>"v2025.3.24"</code>                  |
...
| helm.releases.kubestash.version                                         |                                 | <code>"v2025.3.24"</code>                  |
...
| helm.releases.license-proxyserver.version                               |                                 | <code>"v2025.4.30"</code>                  |
...
| helm.releases.opscenter-features.version                                |                                 | <code>"v2025.4.30"</code>                  |
...
| helm.releases.service-backend.version                                   |                                 | <code>"v2025.4.30"</code>                  |
| helm.releases.service-gateway.version                                   |                                 | <code>"v2025.4.30"</code>                  |
| helm.releases.service-gateway-presets.version                           |                                 | <code>"v2025.4.30"</code>                  |
| helm.releases.service-provider.version                                  |                                 | <code>"v2025.4.30"</code>                  |
...
| helm.releases.stash-presets.version                                     |                                 | <code>"v2025.4.30"</code>                  |
...
| helm.releases.cluster-manager-hub.version                               |                                 | <code>"v2025.4.30"</code>                  |
...
| helm.releases.managed-serviceaccount-manager.version                    |                                 | <code>"v2025.4.30"</code>                  |
...
| helm.releases.cluster-auth-manager.version                              |                                 | <code>"v2025.4.30"</code>                  |
...
| helm.releases.fluxcd-manager.version                                    |                                 | <code>"v2025.4.30"</code>                  |
| helm.releases.license-proxyserver-manager.version                       |                                 | <code>"v2025.4.30"</code>                  |
| helm.releases.inbox-server.version                                      |                                 | <code>"v2025.2.28"</code>                  |
| helm.releases.inbox-agent.version                                       |                                 | <code>"v2024.12.30"</code>                 |
| helm.releases.inbox-ui.version                                          |                                 | <code>"v2025.4.30"</code>                  |
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2025.4.30 --set clusterMetadata.uid=TBD
```
...
```bash
$ helm upgrade -i opscenter-features appscode/opscenter-features -n kubeops --create-namespace --version=v2025.4.30 --values values.yaml
```

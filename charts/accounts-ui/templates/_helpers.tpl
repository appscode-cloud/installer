...
Common labels
*/}}
{{- define "accounts-ui.labels" -}}
helm.sh/chart: {{ include "accounts-ui.chart" . }}
{{ include "accounts-ui.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "accounts-ui.selectorLabels" -}}
app.kubernetes.io/name: {{ include "accounts-ui.name" . }}

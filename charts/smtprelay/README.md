...
$ helm repo update
$ helm search repo appscode/smtprelay --version=v2025.4.30
$ helm upgrade -i smtprelay appscode/smtprelay -n ace --create-namespace --version=v2025.4.30
```
...
```bash
$ helm upgrade -i smtprelay appscode/smtprelay -n ace --create-namespace --version=v2025.4.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i smtprelay appscode/smtprelay -n ace --create-namespace --version=v2025.4.30 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/smtprelay --version=v2022.06.14
$ helm upgrade -i smtprelay appscode/smtprelay -n ace-system --create-namespace --version=v2022.06.14
```
...
| logLevel                                   |                                                                                                                                                                     | <code>"trace"</code>                                                                                     |
| smtp.hostname                              |                                                                                                                                                                     | <code>""</code>                                                                                          |
...
```bash
$ helm upgrade -i smtprelay appscode/smtprelay -n ace-system --create-namespace --version=v2022.06.14 --set replicaCount=1
```
...
```bash
$ helm upgrade -i smtprelay appscode/smtprelay -n ace-system --create-namespace --version=v2022.06.14 --values values.yaml
```

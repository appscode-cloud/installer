...
$ helm repo update
$ helm search repo appscode/smtprelay --version=v2025.1.17
$ helm upgrade -i smtprelay appscode/smtprelay -n ace --create-namespace --version=v2025.1.17
```
...
```bash
$ helm upgrade -i smtprelay appscode/smtprelay -n ace --create-namespace --version=v2025.1.17 --set replicaCount=1
```
...
```bash
$ helm upgrade -i smtprelay appscode/smtprelay -n ace --create-namespace --version=v2025.1.17 --values values.yaml
```

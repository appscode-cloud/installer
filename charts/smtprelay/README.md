...
$ helm repo update
$ helm search repo appscode/smtprelay --version=v2025.6.16
$ helm upgrade -i smtprelay appscode/smtprelay -n ace --create-namespace --version=v2025.6.16
```
...
```bash
$ helm upgrade -i smtprelay appscode/smtprelay -n ace --create-namespace --version=v2025.6.16 --set replicaCount=1
```
...
```bash
$ helm upgrade -i smtprelay appscode/smtprelay -n ace --create-namespace --version=v2025.6.16 --values values.yaml
```

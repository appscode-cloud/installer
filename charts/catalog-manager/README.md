...
$ helm repo update
$ helm search repo appscode/catalog-manager --version=v2025.7.31
$ helm upgrade -i catalog-manager appscode/catalog-manager -n ace --create-namespace --version=v2025.7.31
```
...
```bash
$ helm upgrade -i catalog-manager appscode/catalog-manager -n ace --create-namespace --version=v2025.7.31 --set proxies.appscode=r.appscode.com
```
...
```bash
$ helm upgrade -i catalog-manager appscode/catalog-manager -n ace --create-namespace --version=v2025.7.31 --values values.yaml
```

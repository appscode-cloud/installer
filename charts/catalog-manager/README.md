...
$ helm repo update
$ helm search repo appscode/catalog-manager --version=v2025.6.16
$ helm upgrade -i catalog-manager appscode/catalog-manager -n ace --create-namespace --version=v2025.6.16
```
...
```bash
$ helm upgrade -i catalog-manager appscode/catalog-manager -n ace --create-namespace --version=v2025.6.16 --set proxies.appscode=r.appscode.com
```
...
```bash
$ helm upgrade -i catalog-manager appscode/catalog-manager -n ace --create-namespace --version=v2025.6.16 --values values.yaml
```

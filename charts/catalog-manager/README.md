...
$ helm repo update
$ helm search repo appscode/catalog-manager --version=v2025.4.15
$ helm upgrade -i catalog-manager appscode/catalog-manager -n ace --create-namespace --version=v2025.4.15
```
...
```bash
$ helm upgrade -i catalog-manager appscode/catalog-manager -n ace --create-namespace --version=v2025.4.15 --set proxies.appscode=r.appscode.com
```
...
```bash
$ helm upgrade -i catalog-manager appscode/catalog-manager -n ace --create-namespace --version=v2025.4.15 --values values.yaml
```

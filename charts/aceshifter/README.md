...
$ helm repo update
$ helm search repo appscode/aceshifter --version=v2026.4.30
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2026.4.30
```
...
```bash
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2026.4.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2026.4.30 --values values.yaml
```

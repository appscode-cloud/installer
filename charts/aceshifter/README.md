...
$ helm repo update
$ helm search repo appscode/aceshifter --version=v2025.8.15
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2025.8.15
```
...
```bash
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2025.8.15 --set replicaCount=1
```
...
```bash
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2025.8.15 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/aceshifter --version=v2024.12.9
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2024.12.9
```
...
```bash
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2024.12.9 --set replicaCount=1
```
...
```bash
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2024.12.9 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/aceshifter --version=v2025.7.16
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2025.7.16
```
...
```bash
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2025.7.16 --set replicaCount=1
```
...
```bash
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2025.7.16 --values values.yaml
```

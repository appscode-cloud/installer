...
$ helm repo update
$ helm search repo appscode/aceshifter --version=v2026.5.22
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2026.5.22
```
...
```bash
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2026.5.22 --set replicaCount=1
```
...
```bash
$ helm upgrade -i aceshifter appscode/aceshifter -n ace --create-namespace --version=v2026.5.22 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/kubedb-ui --version=v2024.4.2
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2024.4.2
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2024.4.2 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2024.4.2 --values values.yaml
```

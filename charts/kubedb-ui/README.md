...
$ helm repo update
$ helm search repo appscode/kubedb-ui --version=v2024.10.17
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2024.10.17
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2024.10.17 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2024.10.17 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/kubedb-ui --version=v2024.6.28
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2024.6.28
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2024.6.28 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2024.6.28 --values values.yaml
```

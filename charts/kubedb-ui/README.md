...
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n kubeops --create-namespace --version=0.1.0
```
...
```bash
$ helm uninstall kubedb-ui -n kubeops
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n kubeops --create-namespace --version=0.1.0 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n kubeops --create-namespace --version=0.1.0 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/kubedb-ui --version=v2024.9.30
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2024.9.30
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2024.9.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2024.9.30 --values values.yaml
```

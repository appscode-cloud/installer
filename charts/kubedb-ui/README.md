...
$ helm repo update
$ helm search repo appscode/kubedb-ui --version=v2022.06.14
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace-system --create-namespace --version=v2022.06.14
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace-system --create-namespace --version=v2022.06.14 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace-system --create-namespace --version=v2022.06.14 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/kubedb-ui --version=v2023.12.20
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2023.12.20
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2023.12.20 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kubedb-ui appscode/kubedb-ui -n ace --create-namespace --version=v2023.12.20 --values values.yaml
```

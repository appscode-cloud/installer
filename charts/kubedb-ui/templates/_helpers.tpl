...
Common labels
*/}}
{{- define "kubedb-ui.labels" -}}
helm.sh/chart: {{ include "kubedb-ui.chart" . }}
{{ include "kubedb-ui.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kubedb-ui.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kubedb-ui.name" . }}

...
*/}}
{{- define "license-proxyserver.name" -}}
...
*/}}
{{- define "license-proxyserver.fullname" -}}
...
*/}}
{{- define "license-proxyserver.chart" -}}
...
Common labels
*/}}
{{- define "license-proxyserver.labels" -}}
helm.sh/chart: {{ include "license-proxyserver.chart" . }}
{{ include "license-proxyserver.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "license-proxyserver.selectorLabels" -}}
app.kubernetes.io/name: {{ include "license-proxyserver.name" . }}
...
*/}}
{{- define "license-proxyserver.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "license-proxyserver.fullname" .) .Values.serviceAccount.name }}
{{- else }}

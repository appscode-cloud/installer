...
*/}}
{{- define "kube-bind-server.fullname" -}}
...
Common labels
*/}}
{{- define "kube-bind-server.labels" -}}
helm.sh/chart: {{ include "kube-bind-server.chart" . }}
{{ include "kube-bind-server.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kube-bind-server.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kube-bind-server.name" . }}
...
*/}}
{{- define "kube-bind-server.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kube-bind-server.fullname" .) .Values.serviceAccount.name }}
{{- else }}

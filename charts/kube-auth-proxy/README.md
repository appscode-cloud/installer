...
$ helm repo update
$ helm search repo appscode/kube-auth-proxy --version=v2023.10.18
$ helm upgrade -i kube-auth-proxy appscode/kube-auth-proxy -n kubeops --create-namespace --version=v2023.10.18
```
...
```bash
$ helm upgrade -i kube-auth-proxy appscode/kube-auth-proxy -n kubeops --create-namespace --version=v2023.10.18 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kube-auth-proxy appscode/kube-auth-proxy -n kubeops --create-namespace --version=v2023.10.18 --values values.yaml
```

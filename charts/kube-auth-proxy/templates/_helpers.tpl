...
*/}}
{{- define "kube-auth-proxy.fullname" -}}
...
Common labels
*/}}
{{- define "kube-auth-proxy.labels" -}}
helm.sh/chart: {{ include "kube-auth-proxy.chart" . }}
{{ include "kube-auth-proxy.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kube-auth-proxy.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kube-auth-proxy.name" . }}
...
*/}}
{{- define "kube-auth-proxy.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kube-auth-proxy.fullname" .) .Values.serviceAccount.name }}
{{- else }}

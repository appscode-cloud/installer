...
$ helm repo update
$ helm search repo appscode/gh-ci-webhook --version=v2026.7.10
$ helm upgrade -i gh-ci-webhook appscode/gh-ci-webhook -n ace --create-namespace --version=v2026.7.10
```
...
```bash
$ helm upgrade -i gh-ci-webhook appscode/gh-ci-webhook -n ace --create-namespace --version=v2026.7.10 --set replicaCount=1
```
...
```bash
$ helm upgrade -i gh-ci-webhook appscode/gh-ci-webhook -n ace --create-namespace --version=v2026.7.10 --values values.yaml
```

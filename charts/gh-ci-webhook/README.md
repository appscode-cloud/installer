...
$ helm repo update
$ helm search repo appscode/gh-ci-webhook --version=v2025.12.15
$ helm upgrade -i gh-ci-webhook appscode/gh-ci-webhook -n ace --create-namespace --version=v2025.12.15
```
...
```bash
$ helm upgrade -i gh-ci-webhook appscode/gh-ci-webhook -n ace --create-namespace --version=v2025.12.15 --set replicaCount=1
```
...
```bash
$ helm upgrade -i gh-ci-webhook appscode/gh-ci-webhook -n ace --create-namespace --version=v2025.12.15 --values values.yaml
```

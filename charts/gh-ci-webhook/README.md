...
$ helm repo update
$ helm search repo appscode/gh-ci-webhook --version=v2025.9.30
$ helm upgrade -i gh-ci-webhook appscode/gh-ci-webhook -n ace --create-namespace --version=v2025.9.30
```
...
```bash
$ helm upgrade -i gh-ci-webhook appscode/gh-ci-webhook -n ace --create-namespace --version=v2025.9.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i gh-ci-webhook appscode/gh-ci-webhook -n ace --create-namespace --version=v2025.9.30 --values values.yaml
```

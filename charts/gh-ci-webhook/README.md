...
$ helm repo update
$ helm search repo appscode/gh-ci-webhook --version=v2026.9.11
$ helm upgrade -i gh-ci-webhook appscode/gh-ci-webhook -n ace --create-namespace --version=v2026.9.11
```
...
```bash
$ helm upgrade -i gh-ci-webhook appscode/gh-ci-webhook -n ace --create-namespace --version=v2026.9.11 --set replicaCount=1
```
...
```bash
$ helm upgrade -i gh-ci-webhook appscode/gh-ci-webhook -n ace --create-namespace --version=v2026.9.11 --values values.yaml
```

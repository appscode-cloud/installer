...
$ helm repo update
$ helm search repo appscode/offline-license-server --version=v2026.7.10
$ helm upgrade -i offline-license-server appscode/offline-license-server -n ace --create-namespace --version=v2026.7.10
```
...
```bash
$ helm upgrade -i offline-license-server appscode/offline-license-server -n ace --create-namespace --version=v2026.7.10 --set replicaCount=1
```
...
```bash
$ helm upgrade -i offline-license-server appscode/offline-license-server -n ace --create-namespace --version=v2026.7.10 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/offline-license-server --version=v2025.7.16
$ helm upgrade -i offline-license-server appscode/offline-license-server -n ace --create-namespace --version=v2025.7.16
```
...
```bash
$ helm upgrade -i offline-license-server appscode/offline-license-server -n ace --create-namespace --version=v2025.7.16 --set replicaCount=1
```
...
```bash
$ helm upgrade -i offline-license-server appscode/offline-license-server -n ace --create-namespace --version=v2025.7.16 --values values.yaml
```

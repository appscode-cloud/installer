...
$ helm repo update
$ helm search repo appscode/offline-license-server --version=v2026.6.19
$ helm upgrade -i offline-license-server appscode/offline-license-server -n ace --create-namespace --version=v2026.6.19
```
...
```bash
$ helm upgrade -i offline-license-server appscode/offline-license-server -n ace --create-namespace --version=v2026.6.19 --set replicaCount=1
```
...
```bash
$ helm upgrade -i offline-license-server appscode/offline-license-server -n ace --create-namespace --version=v2026.6.19 --values values.yaml
```

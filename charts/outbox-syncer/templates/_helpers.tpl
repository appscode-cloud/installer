...
Common labels
*/}}
{{- define "outbox-syncer.labels" -}}
helm.sh/chart: {{ include "outbox-syncer.chart" . }}
{{ include "outbox-syncer.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "outbox-syncer.selectorLabels" -}}
app.kubernetes.io/name: {{ include "outbox-syncer.name" . }}
...
{{- .Values.settings.natsMountPath }}
{{- end }}

{{- define "settings.natsSecretName" -}}
{{- .Values.settings.secretName.natsCred }}
{{- end }}

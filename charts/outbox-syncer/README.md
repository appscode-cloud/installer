...
$ helm repo update
$ helm search repo appscode/outbox-syncer --version=v2025.7.31
$ helm upgrade -i outbox-syncer appscode/outbox-syncer -n ace --create-namespace --version=v2025.7.31
```
...
```bash
$ helm upgrade -i outbox-syncer appscode/outbox-syncer -n ace --create-namespace --version=v2025.7.31 --set replicaCount=1
```
...
```bash
$ helm upgrade -i outbox-syncer appscode/outbox-syncer -n ace --create-namespace --version=v2025.7.31 --values values.yaml
```

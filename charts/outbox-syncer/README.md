...
$ helm repo update
$ helm search repo appscode/outbox-syncer --version=v2026.5.22
$ helm upgrade -i outbox-syncer appscode/outbox-syncer -n ace --create-namespace --version=v2026.5.22
```
...
```bash
$ helm upgrade -i outbox-syncer appscode/outbox-syncer -n ace --create-namespace --version=v2026.5.22 --set replicaCount=1
```
...
```bash
$ helm upgrade -i outbox-syncer appscode/outbox-syncer -n ace --create-namespace --version=v2026.5.22 --values values.yaml
```

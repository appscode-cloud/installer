...
$ helm repo update
$ helm search repo appscode/outbox-syncer --version=v2026.6.12
$ helm upgrade -i outbox-syncer appscode/outbox-syncer -n ace --create-namespace --version=v2026.6.12
```
...
```bash
$ helm upgrade -i outbox-syncer appscode/outbox-syncer -n ace --create-namespace --version=v2026.6.12 --set replicaCount=1
```
...
```bash
$ helm upgrade -i outbox-syncer appscode/outbox-syncer -n ace --create-namespace --version=v2026.6.12 --values values.yaml
```

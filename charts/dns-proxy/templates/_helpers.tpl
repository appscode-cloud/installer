...
Common labels
*/}}
{{- define "dns-proxy.labels" -}}
helm.sh/chart: {{ include "dns-proxy.chart" . }}
{{ include "dns-proxy.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "dns-proxy.selectorLabels" -}}
app.kubernetes.io/name: {{ include "dns-proxy.name" . }}

...
$ helm repo update
$ helm search repo appscode/dns-proxy --version=v2026.4.30
$ helm upgrade -i dns-proxy appscode/dns-proxy -n ace --create-namespace --version=v2026.4.30
```
...
```bash
$ helm upgrade -i dns-proxy appscode/dns-proxy -n ace --create-namespace --version=v2026.4.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i dns-proxy appscode/dns-proxy -n ace --create-namespace --version=v2026.4.30 --values values.yaml
```

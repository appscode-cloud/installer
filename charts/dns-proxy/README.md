...
$ helm repo update
$ helm search repo appscode/dns-proxy --version=v2025.1.17
$ helm upgrade -i dns-proxy appscode/dns-proxy -n ace --create-namespace --version=v2025.1.17
```
...
```bash
$ helm upgrade -i dns-proxy appscode/dns-proxy -n ace --create-namespace --version=v2025.1.17 --set replicaCount=1
```
...
```bash
$ helm upgrade -i dns-proxy appscode/dns-proxy -n ace --create-namespace --version=v2025.1.17 --values values.yaml
```

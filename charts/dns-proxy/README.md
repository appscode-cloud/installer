...
$ helm repo update
$ helm search repo appscode/dns-proxy --version=v2025.5.16
$ helm upgrade -i dns-proxy appscode/dns-proxy -n ace --create-namespace --version=v2025.5.16
```
...
```bash
$ helm upgrade -i dns-proxy appscode/dns-proxy -n ace --create-namespace --version=v2025.5.16 --set replicaCount=1
```
...
```bash
$ helm upgrade -i dns-proxy appscode/dns-proxy -n ace --create-namespace --version=v2025.5.16 --values values.yaml
```

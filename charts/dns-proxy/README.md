...
$ helm repo update
$ helm search repo appscode/dns-proxy --version=v2026.6.19
$ helm upgrade -i dns-proxy appscode/dns-proxy -n ace --create-namespace --version=v2026.6.19
```
...
```bash
$ helm upgrade -i dns-proxy appscode/dns-proxy -n ace --create-namespace --version=v2026.6.19 --set replicaCount=1
```
...
```bash
$ helm upgrade -i dns-proxy appscode/dns-proxy -n ace --create-namespace --version=v2026.6.19 --values values.yaml
```

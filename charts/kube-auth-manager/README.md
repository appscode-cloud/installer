...
$ helm repo update
$ helm search repo appscode/kube-auth-manager --version=v2023.10.1
$ helm upgrade -i kube-auth-manager appscode/kube-auth-manager -n kubeops --create-namespace --version=v2023.10.1
```
...
```bash
$ helm upgrade -i kube-auth-manager appscode/kube-auth-manager -n kubeops --create-namespace --version=v2023.10.1 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kube-auth-manager appscode/kube-auth-manager -n kubeops --create-namespace --version=v2023.10.1 --values values.yaml
```

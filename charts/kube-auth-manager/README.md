...
$ helm repo update
$ helm search repo appscode/kube-auth-manager --version=v2023.10.18
$ helm upgrade -i kube-auth-manager appscode/kube-auth-manager -n kubeops --create-namespace --version=v2023.10.18
```
...
```bash
$ helm upgrade -i kube-auth-manager appscode/kube-auth-manager -n kubeops --create-namespace --version=v2023.10.18 --set replicaCount=1
```
...
```bash
$ helm upgrade -i kube-auth-manager appscode/kube-auth-manager -n kubeops --create-namespace --version=v2023.10.18 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/marketplace-ui --version=v2025.8.31
$ helm upgrade -i marketplace-ui appscode/marketplace-ui -n ace --create-namespace --version=v2025.8.31
```
...
```bash
$ helm upgrade -i marketplace-ui appscode/marketplace-ui -n ace --create-namespace --version=v2025.8.31 --set replicaCount=1
```
...
```bash
$ helm upgrade -i marketplace-ui appscode/marketplace-ui -n ace --create-namespace --version=v2025.8.31 --values values.yaml
```

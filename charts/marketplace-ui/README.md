...
$ helm repo update
$ helm search repo appscode/marketplace-ui --version=v2025.10.17
$ helm upgrade -i marketplace-ui appscode/marketplace-ui -n ace --create-namespace --version=v2025.10.17
```
...
```bash
$ helm upgrade -i marketplace-ui appscode/marketplace-ui -n ace --create-namespace --version=v2025.10.17 --set replicaCount=1
```
...
```bash
$ helm upgrade -i marketplace-ui appscode/marketplace-ui -n ace --create-namespace --version=v2025.10.17 --values values.yaml
```

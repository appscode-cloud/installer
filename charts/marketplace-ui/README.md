...
$ helm repo update
$ helm search repo appscode/marketplace-ui --version=v2026.6.19
$ helm upgrade -i marketplace-ui appscode/marketplace-ui -n ace --create-namespace --version=v2026.6.19
```
...
```bash
$ helm upgrade -i marketplace-ui appscode/marketplace-ui -n ace --create-namespace --version=v2026.6.19 --set replicaCount=1
```
...
```bash
$ helm upgrade -i marketplace-ui appscode/marketplace-ui -n ace --create-namespace --version=v2026.6.19 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/s3proxy --version=v2025.7.16
$ helm upgrade -i s3proxy appscode/s3proxy -n ace --create-namespace --version=v2025.7.16
```
...
```bash
$ helm upgrade -i s3proxy appscode/s3proxy -n ace --create-namespace --version=v2025.7.16 --set replicaCount=1
```
...
```bash
$ helm upgrade -i s3proxy appscode/s3proxy -n ace --create-namespace --version=v2025.7.16 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/ace-ocm-addons --version=v2024.8.21
$ helm upgrade -i ace-ocm-addons appscode/ace-ocm-addons -n open-cluster-management --create-namespace --version=v2024.8.21
```
...
```bash
$ helm upgrade -i ace-ocm-addons appscode/ace-ocm-addons -n open-cluster-management --create-namespace --version=v2024.8.21 --set image.proxies.appscode=r.appscode.com
```
...
```bash
$ helm upgrade -i ace-ocm-addons appscode/ace-ocm-addons -n open-cluster-management --create-namespace --version=v2024.8.21 --values values.yaml
```

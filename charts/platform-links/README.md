...
$ helm repo update
$ helm search repo appscode/platform-links --version=v2026.6.19
$ helm upgrade -i platform-links appscode/platform-links -n ace --create-namespace --version=v2026.6.19
```
...
```bash
$ helm upgrade -i platform-links appscode/platform-links -n ace --create-namespace --version=v2026.6.19 --set replicaCount=1
```
...
```bash
$ helm upgrade -i platform-links appscode/platform-links -n ace --create-namespace --version=v2026.6.19 --values values.yaml
```

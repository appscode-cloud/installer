...
$ helm repo update
$ helm search repo appscode/platform-links --version=v2024.11.18
$ helm upgrade -i platform-links appscode/platform-links -n ace --create-namespace --version=v2024.11.18
```
...
```bash
$ helm upgrade -i platform-links appscode/platform-links -n ace --create-namespace --version=v2024.11.18 --set replicaCount=1
```
...
```bash
$ helm upgrade -i platform-links appscode/platform-links -n ace --create-namespace --version=v2024.11.18 --values values.yaml
```

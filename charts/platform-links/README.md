...
$ helm repo update
$ helm search repo appscode/platform-links --version=v2024.10.17
$ helm upgrade -i platform-links appscode/platform-links -n ace --create-namespace --version=v2024.10.17
```
...
```bash
$ helm upgrade -i platform-links appscode/platform-links -n ace --create-namespace --version=v2024.10.17 --set replicaCount=1
```
...
```bash
$ helm upgrade -i platform-links appscode/platform-links -n ace --create-namespace --version=v2024.10.17 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/platform-links --version=v2024.9.30
$ helm upgrade -i platform-links appscode/platform-links -n ace --create-namespace --version=v2024.9.30
```
...
```bash
$ helm upgrade -i platform-links appscode/platform-links -n ace --create-namespace --version=v2024.9.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i platform-links appscode/platform-links -n ace --create-namespace --version=v2024.9.30 --values values.yaml
```

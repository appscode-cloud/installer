...
*/}}
{{- define "platform-links.fullname" -}}
...
Common labels
*/}}
{{- define "platform-links.labels" -}}
helm.sh/chart: {{ include "platform-links.chart" . }}
{{ include "platform-links.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "platform-links.selectorLabels" -}}
app.kubernetes.io/name: {{ include "platform-links.name" . }}

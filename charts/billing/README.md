...
$ helm repo update
$ helm search repo appscode/billing --version=v2025.10.31
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.10.31
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.10.31 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.10.31 --values values.yaml
```

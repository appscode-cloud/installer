...
$ helm repo update
$ helm search repo appscode/billing --version=v2024.7.2
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.7.2
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.7.2 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.7.2 --values values.yaml
```

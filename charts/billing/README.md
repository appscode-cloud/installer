...
$ helm repo update
$ helm search repo appscode/billing --version=v2024.8.21
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.8.21
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.8.21 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.8.21 --values values.yaml
```

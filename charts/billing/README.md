...
$ helm repo update
$ helm search repo appscode/billing --version=v2026.9.11
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2026.9.11
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2026.9.11 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2026.9.11 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/billing --version=v2024.7.4
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.7.4
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.7.4 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.7.4 --values values.yaml
```

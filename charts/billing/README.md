...
$ helm repo update
$ helm search repo appscode/billing --version=v2025.8.15
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.8.15
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.8.15 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.8.15 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/billing --version=v2024.6.28
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.6.28
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.6.28 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.6.28 --values values.yaml
```

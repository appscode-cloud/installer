...
$ helm repo update
$ helm search repo appscode/billing --version=v2026.6.19
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2026.6.19
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2026.6.19 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2026.6.19 --values values.yaml
```

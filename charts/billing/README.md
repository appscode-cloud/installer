...
$ helm repo update
$ helm search repo appscode/billing --version=v2025.4.30
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.4.30
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.4.30 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.4.30 --values values.yaml
```

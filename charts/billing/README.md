...
$ helm repo update
$ helm search repo appscode/billing --version=v2024.2.13
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.2.13
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.2.13 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.2.13 --values values.yaml
```

...
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2023.10.1
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2023.10.1 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2023.10.1 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/billing --version=v2024.10.24
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.10.24
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.10.24 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.10.24 --values values.yaml
```

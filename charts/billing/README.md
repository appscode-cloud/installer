...
$ helm repo update
$ helm search repo appscode/billing --version=v2024.12.9
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.12.9
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.12.9 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.12.9 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/billing --version=v2025.3.14
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.3.14
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.3.14 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.3.14 --values values.yaml
```

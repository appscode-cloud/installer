...
$ helm repo update
$ helm search repo appscode/billing --version=v2026.7.10
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2026.7.10
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2026.7.10 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2026.7.10 --values values.yaml
```

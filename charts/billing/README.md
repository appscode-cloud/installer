...
$ helm repo update
$ helm search repo appscode/billing --version=v2025.7.16
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.7.16
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.7.16 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2025.7.16 --values values.yaml
```

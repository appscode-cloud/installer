...
$ helm repo update
$ helm search repo appscode/billing --version=v2024.10.17
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.10.17
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.10.17 --set replicaCount=3
```
...
```bash
$ helm upgrade -i billing appscode/billing -n ace --create-namespace --version=v2024.10.17 --values values.yaml
```

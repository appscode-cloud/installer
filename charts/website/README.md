...
$ helm repo update
$ helm search repo appscode/website --version=v2025.12.15
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.12.15
```
...
| image.repository                           | App container image                                                                                                                  | <code>website</code>                                                                                                                           |
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.12.15 --set replicaCount=1
```
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.12.15 --values values.yaml
```

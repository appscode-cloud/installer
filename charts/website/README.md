...
$ helm repo update
$ helm search repo appscode/website --version=v2025.5.16
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.5.16
```
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.5.16 --set replicaCount=1
```
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.5.16 --values values.yaml
```

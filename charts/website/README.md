...
$ helm repo update
$ helm search repo appscode/website --version=v2026.3.30
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2026.3.30
```
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2026.3.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2026.3.30 --values values.yaml
```

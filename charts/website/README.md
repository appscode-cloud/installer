...
$ helm repo update
$ helm search repo appscode/website --version=v2025.2.28
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.2.28
```
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.2.28 --set replicaCount=1
```
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.2.28 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/website --version=v2025.1.17
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.1.17
```
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.1.17 --set replicaCount=1
```
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.1.17 --values values.yaml
```

...
$ helm repo update
$ helm search repo appscode/website --version=v2025.8.31
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.8.31
```
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.8.31 --set replicaCount=1
```
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.8.31 --values values.yaml
```

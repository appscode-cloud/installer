...
$ helm repo update
$ helm search repo appscode/website --version=v2025.9.30
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.9.30
```
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.9.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i website appscode/website -n ace --create-namespace --version=v2025.9.30 --values values.yaml
```

...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-ops-manager:v0.50.0 images/kubedb-kubedb-ops-manager-v0.50.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-provisioner:v0.63.0 images/kubedb-kubedb-provisioner-v0.63.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-schema-manager:v0.39.0 images/kubedb-kubedb-schema-manager-v0.39.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-ui-server:v0.39.0 images/kubedb-kubedb-ui-server-v0.39.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-webhook-server:v0.39.0 images/kubedb-kubedb-webhook-server-v0.39.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/pg-coordinator:v0.47.0 images/kubedb-pg-coordinator-v0.47.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.24.0_16.1-alpine images/kubedb-postgres-archiver-v0.24.0_16.1-alpine.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-restic-plugin:v0.26.0_16.1 images/kubedb-postgres-restic-plugin-v0.26.0_16.1.tar

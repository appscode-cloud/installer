...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-autoscaler:v0.45.0 images/kubedb-kubedb-autoscaler-v0.45.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-crd-manager:v0.15.0 images/kubedb-kubedb-crd-manager-v0.15.0.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.21.0_16.1-alpine images/kubedb-postgres-archiver-v0.21.0_16.1-alpine.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-restic-plugin:v0.23.0_16.1 images/kubedb-postgres-restic-plugin-v0.23.0_16.1.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/redis-coordinator:v0.39.0 images/kubedb-redis-coordinator-v0.39.0.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/redis-init:0.12.1 images/kubedb-redis-init-0.12.1.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/redis-restic-plugin:v0.23.0 images/kubedb-redis-restic-plugin-v0.23.0.tar

...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-autoscaler:v0.46.0-rc.1 images/kubedb-kubedb-autoscaler-v0.46.0-rc.1.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-crd-manager:v0.16.0-rc.1 images/kubedb-kubedb-crd-manager-v0.16.0-rc.1.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-ops-manager:v0.48.0-rc.1 images/kubedb-kubedb-ops-manager-v0.48.0-rc.1.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-provisioner:v0.61.0-rc.1 images/kubedb-kubedb-provisioner-v0.61.0-rc.1.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-schema-manager:v0.37.0-rc.1 images/kubedb-kubedb-schema-manager-v0.37.0-rc.1.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-ui-server:v0.37.0-rc.1 images/kubedb-kubedb-ui-server-v0.37.0-rc.1.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-webhook-server:v0.37.0-rc.1 images/kubedb-kubedb-webhook-server-v0.37.0-rc.1.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.22.0-rc.1_16.1-alpine images/kubedb-postgres-archiver-v0.22.0-rc.1_16.1-alpine.tar
...
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/redis-coordinator:v0.40.0-rc.1 images/kubedb-redis-coordinator-v0.40.0-rc.1.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/redis-init:0.12.1 images/kubedb-redis-init-0.12.1.tar
$CMD pull --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/redis-restic-plugin:v0.24.0-rc.1 images/kubedb-redis-restic-plugin-v0.24.0-rc.1.tar

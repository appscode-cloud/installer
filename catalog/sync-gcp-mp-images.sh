...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace-installer:v2024.12.9 $IMAGE_REGISTRY/ace-installer:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/b3:v2024.12.9 $IMAGE_REGISTRY/b3:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/cluster-presets:v0.0.6 $IMAGE_REGISTRY/cluster-presets:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/cluster-auth:v0.2.0 $IMAGE_REGISTRY/cluster-auth:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/cluster-gateway-manager:v1.9.2 $IMAGE_REGISTRY/cluster-gateway-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/cluster-gateway:v1.9.2 $IMAGE_REGISTRY/cluster-gateway:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/cluster-profile:v0.3.0 $IMAGE_REGISTRY/cluster-profile:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ops-manager:v0.37.0 $IMAGE_REGISTRY/kubedb-ops-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-provisioner:v0.50.0 $IMAGE_REGISTRY/kubedb-provisioner:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-webhook-server:v0.26.0 $IMAGE_REGISTRY/kubedb-webhook-server:$TAG

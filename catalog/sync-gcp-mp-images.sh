...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/kubectl-nonroot:1.34 $IMAGE_REGISTRY/kubectl-nonroot:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/kubedb-ui:2.0.0 $IMAGE_REGISTRY/kubedb-ui:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/license-proxyserver:v0.1.0 $IMAGE_REGISTRY/license-proxyserver:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/platform-ui:2.0.0 $IMAGE_REGISTRY/platform-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/sidekick:v0.0.14 $IMAGE_REGISTRY/sidekick:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/cluster-auth:v0.5.1 $IMAGE_REGISTRY/cluster-auth:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/cluster-profile:v0.11.5 $IMAGE_REGISTRY/cluster-profile:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-autoscaler:v0.48.0 $IMAGE_REGISTRY/kubedb-autoscaler:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-crd-manager:v0.18.0 $IMAGE_REGISTRY/kubedb-crd-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ops-manager:v0.50.0 $IMAGE_REGISTRY/kubedb-ops-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-provisioner:v0.63.0 $IMAGE_REGISTRY/kubedb-provisioner:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-schema-manager:v0.39.0 $IMAGE_REGISTRY/kubedb-schema-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ui-server:v0.39.0 $IMAGE_REGISTRY/kubedb-ui-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-webhook-server:v0.39.0 $IMAGE_REGISTRY/kubedb-webhook-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/pg-coordinator:v0.47.0 $IMAGE_REGISTRY/pg-coordinator:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-archiver:v0.24.0_16.1-alpine $IMAGE_REGISTRY/postgres-archiver:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-init:0.19.0 $IMAGE_REGISTRY/postgres-init:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-restic-plugin:v0.26.0_16.1 $IMAGE_REGISTRY/postgres-restic-plugin:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-coordinator:v0.42.0 $IMAGE_REGISTRY/redis-coordinator:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-init:0.12.1 $IMAGE_REGISTRY/redis-init:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-restic-plugin:v0.26.0 $IMAGE_REGISTRY/redis-restic-plugin:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kubestash/kubedump:v0.25.0 $IMAGE_REGISTRY/kubedump:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubestash/kubestash:v0.26.0 $IMAGE_REGISTRY/kubestash:$TAG
...
crane cp --allow-nondistributable-artifacts prometheuscommunity/postgres-exporter:v0.18.1 $IMAGE_REGISTRY/postgres-exporter:$TAG

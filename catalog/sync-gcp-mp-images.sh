...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace-installer:v2025.6.16 $IMAGE_REGISTRY/ace-installer:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace:v2025.6.16 $IMAGE_REGISTRY/ace:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/service-gateway:v2025.6.16 $IMAGE_REGISTRY/service-gateway:$TAG

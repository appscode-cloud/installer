...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace-installer:v2025.3.14 $IMAGE_REGISTRY/ace-installer:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace:v2025.3.14 $IMAGE_REGISTRY/ace:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/service-gateway:v2025.3.14 $IMAGE_REGISTRY/service-gateway:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/catalog-manager:v0.2.3 $IMAGE_REGISTRY/catalog-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/cluster-presets:v0.0.8 $IMAGE_REGISTRY/cluster-presets:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/cluster-ui:0.9.14 $IMAGE_REGISTRY/cluster-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/platform-ui:0.8.13 $IMAGE_REGISTRY/platform-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-autoscaler:v0.37.0 $IMAGE_REGISTRY/kubedb-autoscaler:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-crd-manager:v0.7.0 $IMAGE_REGISTRY/kubedb-crd-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ops-manager:v0.39.0 $IMAGE_REGISTRY/kubedb-ops-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-provisioner:v0.52.0 $IMAGE_REGISTRY/kubedb-provisioner:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-schema-manager:v0.28.0 $IMAGE_REGISTRY/kubedb-schema-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ui-server:v0.28.0 $IMAGE_REGISTRY/kubedb-ui-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-webhook-server:v0.28.0 $IMAGE_REGISTRY/kubedb-webhook-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/pg-coordinator:v0.36.0 $IMAGE_REGISTRY/pg-coordinator:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-archiver:v0.13.0_16.1-alpine $IMAGE_REGISTRY/postgres-archiver:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-init:0.17.1 $IMAGE_REGISTRY/postgres-init:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-restic-plugin:v0.15.0_16.1 $IMAGE_REGISTRY/postgres-restic-plugin:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-coordinator:v0.31.0 $IMAGE_REGISTRY/redis-coordinator:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-init:0.9.0 $IMAGE_REGISTRY/redis-init:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-restic-plugin:v0.15.0 $IMAGE_REGISTRY/redis-restic-plugin:$TAG

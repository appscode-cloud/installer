...
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-crd-manager:v0.8.0-rc.1 $IMAGE_REGISTRY/kubedb-crd-manager:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-provisioner:v0.53.0-rc.1 $IMAGE_REGISTRY/kubedb-provisioner:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ui-server:v0.29.0-rc.1 $IMAGE_REGISTRY/kubedb-ui-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-webhook-server:v0.29.0-rc.1 $IMAGE_REGISTRY/kubedb-webhook-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/pg-coordinator:v0.37.0-rc.1 $IMAGE_REGISTRY/pg-coordinator:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-archiver:v0.14.0-rc.1_16.1-alpine $IMAGE_REGISTRY/postgres-archiver:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-init:0.17.1 $IMAGE_REGISTRY/postgres-init:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-restic-plugin:v0.16.0-rc.1_16.1 $IMAGE_REGISTRY/postgres-restic-plugin:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-coordinator:v0.32.0-rc.1 $IMAGE_REGISTRY/redis-coordinator:$TAG

...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/cluster-ui:1.6.0 $IMAGE_REGISTRY/cluster-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/kubedb-ui:1.6.0 $IMAGE_REGISTRY/kubedb-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/platform-ui:1.6.0 $IMAGE_REGISTRY/platform-ui:$TAG

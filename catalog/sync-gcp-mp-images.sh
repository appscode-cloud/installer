...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace-installer:v2025.7.16 $IMAGE_REGISTRY/ace-installer:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace:v2025.7.16 $IMAGE_REGISTRY/ace:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/service-gateway:v2025.7.16 $IMAGE_REGISTRY/service-gateway:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/b3:v2025.7.16 $IMAGE_REGISTRY/b3:$TAG

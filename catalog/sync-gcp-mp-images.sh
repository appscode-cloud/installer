...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace-installer:v2025.6.30 $IMAGE_REGISTRY/ace-installer:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace:v2025.6.30 $IMAGE_REGISTRY/ace:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/service-gateway:v2025.6.30 $IMAGE_REGISTRY/service-gateway:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/b3:v2025.6.30 $IMAGE_REGISTRY/b3:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/catalog-manager:v0.6.1 $IMAGE_REGISTRY/catalog-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/cluster-presets:v0.0.9 $IMAGE_REGISTRY/cluster-presets:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/cluster-ui:1.5.0 $IMAGE_REGISTRY/cluster-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/inbox-ui:0.0.5 $IMAGE_REGISTRY/inbox-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/platform-ui:1.5.0 $IMAGE_REGISTRY/platform-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/fluxcd-addon:v0.0.8 $IMAGE_REGISTRY/fluxcd-addon:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-autoscaler:v0.40.0 $IMAGE_REGISTRY/kubedb-autoscaler:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-crd-manager:v0.10.0 $IMAGE_REGISTRY/kubedb-crd-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ops-manager:v0.42.0 $IMAGE_REGISTRY/kubedb-ops-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-provisioner:v0.55.0 $IMAGE_REGISTRY/kubedb-provisioner:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-schema-manager:v0.31.0 $IMAGE_REGISTRY/kubedb-schema-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ui-server:v0.31.0 $IMAGE_REGISTRY/kubedb-ui-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-webhook-server:v0.31.0 $IMAGE_REGISTRY/kubedb-webhook-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/pg-coordinator:v0.39.0 $IMAGE_REGISTRY/pg-coordinator:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-archiver:v0.16.0_16.1-alpine $IMAGE_REGISTRY/postgres-archiver:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-init:0.17.2 $IMAGE_REGISTRY/postgres-init:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-restic-plugin:v0.18.0_16.1 $IMAGE_REGISTRY/postgres-restic-plugin:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-coordinator:v0.34.0 $IMAGE_REGISTRY/redis-coordinator:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-init:0.11.0 $IMAGE_REGISTRY/redis-init:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-restic-plugin:v0.18.0 $IMAGE_REGISTRY/redis-restic-plugin:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kubestash/kubedump:v0.18.0 $IMAGE_REGISTRY/kubedump:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubestash/kubestash:v0.19.0 $IMAGE_REGISTRY/kubestash:$TAG

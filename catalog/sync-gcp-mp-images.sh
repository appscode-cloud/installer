...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/petset:v0.0.12 $IMAGE_REGISTRY/petset:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-autoscaler:v0.43.0 $IMAGE_REGISTRY/kubedb-autoscaler:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-crd-manager:v0.13.0 $IMAGE_REGISTRY/kubedb-crd-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ops-manager:v0.45.0 $IMAGE_REGISTRY/kubedb-ops-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-provisioner:v0.58.0 $IMAGE_REGISTRY/kubedb-provisioner:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-schema-manager:v0.34.0 $IMAGE_REGISTRY/kubedb-schema-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ui-server:v0.34.0 $IMAGE_REGISTRY/kubedb-ui-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-webhook-server:v0.34.0 $IMAGE_REGISTRY/kubedb-webhook-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/pg-coordinator:v0.42.0 $IMAGE_REGISTRY/pg-coordinator:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-archiver:v0.19.0_16.1-alpine $IMAGE_REGISTRY/postgres-archiver:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-init:0.17.2 $IMAGE_REGISTRY/postgres-init:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-restic-plugin:v0.21.0_16.1 $IMAGE_REGISTRY/postgres-restic-plugin:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-coordinator:v0.37.0 $IMAGE_REGISTRY/redis-coordinator:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-init:0.12.0 $IMAGE_REGISTRY/redis-init:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-restic-plugin:v0.21.0 $IMAGE_REGISTRY/redis-restic-plugin:$TAG

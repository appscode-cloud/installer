...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace-installer:v2025.4.30 $IMAGE_REGISTRY/ace-installer:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace:v2025.4.30 $IMAGE_REGISTRY/ace:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/service-gateway:v2025.4.30 $IMAGE_REGISTRY/service-gateway:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/b3:v2025.4.30 $IMAGE_REGISTRY/b3:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/cluster-ui:1.1.0 $IMAGE_REGISTRY/cluster-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/grafana-tools:v0.3.0 $IMAGE_REGISTRY/grafana-tools:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/grafana:v2025.2.3 $IMAGE_REGISTRY/grafana:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/inbox-agent:v0.0.2 $IMAGE_REGISTRY/inbox-agent:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/inbox-server:postgres-latest $IMAGE_REGISTRY/inbox-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/inbox-ui:0.0.4 $IMAGE_REGISTRY/inbox-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/kubedb-ui:1.1.0 $IMAGE_REGISTRY/kubedb-ui:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/license-proxyserver:v0.0.21 $IMAGE_REGISTRY/license-proxyserver:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/platform-ui:1.1.0 $IMAGE_REGISTRY/platform-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/cluster-profile:v0.6.0 $IMAGE_REGISTRY/cluster-profile:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/fluxcd-addon:v0.0.6 $IMAGE_REGISTRY/fluxcd-addon:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-autoscaler:v0.38.0 $IMAGE_REGISTRY/kubedb-autoscaler:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-crd-manager:v0.8.0 $IMAGE_REGISTRY/kubedb-crd-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ops-manager:v0.40.0 $IMAGE_REGISTRY/kubedb-ops-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-provisioner:v0.53.0 $IMAGE_REGISTRY/kubedb-provisioner:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-schema-manager:v0.29.0 $IMAGE_REGISTRY/kubedb-schema-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ui-server:v0.29.0 $IMAGE_REGISTRY/kubedb-ui-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-webhook-server:v0.29.0 $IMAGE_REGISTRY/kubedb-webhook-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/pg-coordinator:v0.37.0 $IMAGE_REGISTRY/pg-coordinator:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-archiver:v0.14.0_16.1-alpine $IMAGE_REGISTRY/postgres-archiver:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-init:0.17.1 $IMAGE_REGISTRY/postgres-init:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-restic-plugin:v0.16.0_16.1 $IMAGE_REGISTRY/postgres-restic-plugin:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-coordinator:v0.32.0 $IMAGE_REGISTRY/redis-coordinator:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-init:0.9.0 $IMAGE_REGISTRY/redis-init:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/redis-restic-plugin:v0.16.0 $IMAGE_REGISTRY/redis-restic-plugin:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kubestash/kubedump:v0.16.0 $IMAGE_REGISTRY/kubedump:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubestash/kubestash:v0.17.0 $IMAGE_REGISTRY/kubestash:$TAG
...
crane cp --allow-nondistributable-artifacts registry.k8s.io/kube-apiserver:v1.20.0 $IMAGE_REGISTRY/kube-apiserver:$TAG
crane cp --allow-nondistributable-artifacts registry.k8s.io/kube-controller-manager:v1.20.0 $IMAGE_REGISTRY/kube-controller-manager:$TAG

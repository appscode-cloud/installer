...
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/cluster-auth:v0.4.0 $IMAGE_REGISTRY/cluster-auth:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/cluster-profile:v0.9.0 $IMAGE_REGISTRY/cluster-profile:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/cluster-proxy:v0.7.0 $IMAGE_REGISTRY/cluster-proxy:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/clusteradm:v0.11.0 $IMAGE_REGISTRY/clusteradm:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/fluxcd-addon:v0.0.7 $IMAGE_REGISTRY/fluxcd-addon:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/managed-serviceaccount:v0.8.0 $IMAGE_REGISTRY/managed-serviceaccount:$TAG

...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace-installer:v2025.4.15 $IMAGE_REGISTRY/ace-installer:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace:v2025.4.15 $IMAGE_REGISTRY/ace:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/service-gateway:v2025.4.15 $IMAGE_REGISTRY/service-gateway:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/b3:v2025.4.15 $IMAGE_REGISTRY/b3:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/kubedb-ui:1.0.0 $IMAGE_REGISTRY/kubedb-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/platform-ui:1.0.0 $IMAGE_REGISTRY/platform-ui:$TAG

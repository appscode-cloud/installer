...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace-installer:v2024.9.30 $IMAGE_REGISTRY/ace-installer:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode-charts/ace:v2024.9.30 $IMAGE_REGISTRY/ace:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/b3:v2024.9.30 $IMAGE_REGISTRY/b3:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/cluster-presets:v0.0.3 $IMAGE_REGISTRY/cluster-presets:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/cluster-ui:0.9.7 $IMAGE_REGISTRY/cluster-ui:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/config-syncer:v0.15.2-ent $IMAGE_REGISTRY/config-syncer:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/csi-driver-cacerts:v0.0.4 $IMAGE_REGISTRY/csi-driver-cacerts:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/grafana:v2024.7.7 $IMAGE_REGISTRY/grafana:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/kube-ui-server:v0.0.46 $IMAGE_REGISTRY/kube-ui-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/kubectl-nonroot:1.25 $IMAGE_REGISTRY/kubectl-nonroot:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/kubedb-ui:0.7.6 $IMAGE_REGISTRY/kubedb-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/appscode/platform-ui:0.8.5 $IMAGE_REGISTRY/platform-ui:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/fluxcd/kustomize-controller:v1.3.0 $IMAGE_REGISTRY/kustomize-controller:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/fluxcd/notification-controller:v1.3.0 $IMAGE_REGISTRY/notification-controller:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/managed-serviceaccount:v0.6.0 $IMAGE_REGISTRY/managed-serviceaccount:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/placement:v0.14.0 $IMAGE_REGISTRY/placement:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/registration-operator:v0.14.0 $IMAGE_REGISTRY/registration-operator:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/registration:v0.14.0 $IMAGE_REGISTRY/registration:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kluster-manager/work:v0.14.0 $IMAGE_REGISTRY/work:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-autoscaler:v0.33.0 $IMAGE_REGISTRY/kubedb-autoscaler:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-crd-manager:v0.3.0 $IMAGE_REGISTRY/kubedb-crd-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ops-manager:v0.35.1 $IMAGE_REGISTRY/kubedb-ops-manager:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-provisioner:v0.48.1 $IMAGE_REGISTRY/kubedb-provisioner:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-ui-server:v0.24.0 $IMAGE_REGISTRY/kubedb-ui-server:$TAG
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/kubedb-webhook-server:v0.24.0 $IMAGE_REGISTRY/kubedb-webhook-server:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/kubedb/postgres-restic-plugin:v0.11.0_16.1 $IMAGE_REGISTRY/postgres-restic-plugin:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/voyagermesh/envoy:v1.29.9-ac $IMAGE_REGISTRY/envoy:$TAG
...
crane cp --allow-nondistributable-artifacts ghcr.io/voyagermesh/gateway:v1.1.1 $IMAGE_REGISTRY/gateway:$TAG
...
crane cp --allow-nondistributable-artifacts registry.k8s.io/sig-storage/csi-node-driver-registrar:v2.10.0 $IMAGE_REGISTRY/csi-node-driver-registrar:$TAG
...
crane cp --allow-nondistributable-artifacts registry.k8s.io/sig-storage/csi-node-driver-registrar:v2.8.0 $IMAGE_REGISTRY/csi-node-driver-registrar:$TAG
...
crane cp --allow-nondistributable-artifacts registry.k8s.io/sig-storage/livenessprobe:v2.10.0 $IMAGE_REGISTRY/csi-driver-livenessprobe:$TAG
crane cp --allow-nondistributable-artifacts registry.k8s.io/sig-storage/livenessprobe:v2.12.0 $IMAGE_REGISTRY/csi-driver-livenessprobe:$TAG

...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-charts-kubedb-opscenter-v2024.12.18.tar $IMAGE_REGISTRY/appscode-charts/kubedb-opscenter:v2024.12.18
...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-charts-license-proxyserver-manager-v2024.12.26.tar $IMAGE_REGISTRY/appscode-charts/license-proxyserver-manager:v2024.12.26
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-charts-license-proxyserver-v2024.12.26.tar $IMAGE_REGISTRY/appscode-charts/license-proxyserver:v2024.12.26

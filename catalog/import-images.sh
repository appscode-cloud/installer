...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-autoscaler-v0.45.0.tar $IMAGE_REGISTRY/kubedb/kubedb-autoscaler:v0.45.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-crd-manager-v0.15.0.tar $IMAGE_REGISTRY/kubedb/kubedb-crd-manager:v0.15.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-ops-manager-v0.47.0.tar $IMAGE_REGISTRY/kubedb/kubedb-ops-manager:v0.47.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-provisioner-v0.60.0.tar $IMAGE_REGISTRY/kubedb/kubedb-provisioner:v0.60.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-schema-manager-v0.36.0.tar $IMAGE_REGISTRY/kubedb/kubedb-schema-manager:v0.36.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-ui-server-v0.36.0.tar $IMAGE_REGISTRY/kubedb/kubedb-ui-server:v0.36.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-archiver-v0.21.0_16.1-alpine.tar $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.21.0_16.1-alpine
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-restic-plugin-v0.23.0_16.1.tar $IMAGE_REGISTRY/kubedb/postgres-restic-plugin:v0.23.0_16.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-redis-coordinator-v0.39.0.tar $IMAGE_REGISTRY/kubedb/redis-coordinator:v0.39.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-redis-restic-plugin-v0.23.0.tar $IMAGE_REGISTRY/kubedb/redis-restic-plugin:v0.23.0

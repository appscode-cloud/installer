...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-ops-manager-v0.50.0.tar $IMAGE_REGISTRY/kubedb/kubedb-ops-manager:v0.50.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-provisioner-v0.63.0.tar $IMAGE_REGISTRY/kubedb/kubedb-provisioner:v0.63.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-schema-manager-v0.39.0.tar $IMAGE_REGISTRY/kubedb/kubedb-schema-manager:v0.39.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-ui-server-v0.39.0.tar $IMAGE_REGISTRY/kubedb/kubedb-ui-server:v0.39.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-webhook-server-v0.39.0.tar $IMAGE_REGISTRY/kubedb/kubedb-webhook-server:v0.39.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-pg-coordinator-v0.47.0.tar $IMAGE_REGISTRY/kubedb/pg-coordinator:v0.47.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-archiver-v0.24.0_16.1-alpine.tar $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.24.0_16.1-alpine
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-restic-plugin-v0.26.0_16.1.tar $IMAGE_REGISTRY/kubedb/postgres-restic-plugin:v0.26.0_16.1

...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-autoscaler-v0.46.0-rc.1.tar $IMAGE_REGISTRY/kubedb/kubedb-autoscaler:v0.46.0-rc.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-crd-manager-v0.16.0-rc.1.tar $IMAGE_REGISTRY/kubedb/kubedb-crd-manager:v0.16.0-rc.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-ops-manager-v0.48.0-rc.1.tar $IMAGE_REGISTRY/kubedb/kubedb-ops-manager:v0.48.0-rc.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-provisioner-v0.61.0-rc.1.tar $IMAGE_REGISTRY/kubedb/kubedb-provisioner:v0.61.0-rc.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-schema-manager-v0.37.0-rc.1.tar $IMAGE_REGISTRY/kubedb/kubedb-schema-manager:v0.37.0-rc.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-ui-server-v0.37.0-rc.1.tar $IMAGE_REGISTRY/kubedb/kubedb-ui-server:v0.37.0-rc.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-webhook-server-v0.37.0-rc.1.tar $IMAGE_REGISTRY/kubedb/kubedb-webhook-server:v0.37.0-rc.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-pg-coordinator-v0.45.0-rc.1.tar $IMAGE_REGISTRY/kubedb/pg-coordinator:v0.45.0-rc.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-archiver-v0.22.0-rc.1_16.1-alpine.tar $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.22.0-rc.1_16.1-alpine
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-restic-plugin-v0.24.0-rc.1_16.1.tar $IMAGE_REGISTRY/kubedb/postgres-restic-plugin:v0.24.0-rc.1_16.1
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-redis-coordinator-v0.40.0-rc.1.tar $IMAGE_REGISTRY/kubedb/redis-coordinator:v0.40.0-rc.1
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-redis-restic-plugin-v0.24.0-rc.1.tar $IMAGE_REGISTRY/kubedb/redis-restic-plugin:v0.24.0-rc.1

...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-charts-ace-installer-v2025.3.14.tar $IMAGE_REGISTRY/appscode-charts/ace-installer:v2025.3.14
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-charts-ace-v2025.3.14.tar $IMAGE_REGISTRY/appscode-charts/ace:v2025.3.14
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-charts-aceshifter-v2025.3.14.tar $IMAGE_REGISTRY/appscode-charts/aceshifter:v2025.3.14
...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-charts-catalog-manager-v2025.3.14.tar $IMAGE_REGISTRY/appscode-charts/catalog-manager:v2025.3.14
...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-charts-kube-ui-server-v2025.3.14.tar $IMAGE_REGISTRY/appscode-charts/kube-ui-server:v2025.3.14
...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-charts-kubedb-ui-presets-v2025.3.14.tar $IMAGE_REGISTRY/appscode-charts/kubedb-ui-presets:v2025.3.14
...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-charts-stash-presets-v2025.3.14.tar $IMAGE_REGISTRY/appscode-charts/stash-presets:v2025.3.14

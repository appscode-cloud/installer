...
$CMD push --allow-nondistributable-artifacts --insecure images/appscode-charts-kubedb-v2025.2.6-rc.0.tar $IMAGE_REGISTRY/appscode-charts/kubedb:v2025.2.6-rc.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-autoscaler-v0.37.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-autoscaler:v0.37.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-crd-manager-v0.7.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-crd-manager:v0.7.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-ops-manager-v0.39.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-ops-manager:v0.39.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-provisioner-v0.52.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-provisioner:v0.52.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-schema-manager-v0.28.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-schema-manager:v0.28.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-ui-server-v0.28.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-ui-server:v0.28.0-rc.0
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-kubedb-webhook-server-v0.28.0-rc.0.tar $IMAGE_REGISTRY/kubedb/kubedb-webhook-server:v0.28.0-rc.0
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-postgres-archiver-v0.13.0-rc.0_16.1-alpine.tar $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.13.0-rc.0_16.1-alpine
...
$CMD push --allow-nondistributable-artifacts --insecure images/kubedb-redis-restic-plugin-v0.15.0-rc.0.tar $IMAGE_REGISTRY/kubedb/redis-restic-plugin:v0.15.0-rc.0

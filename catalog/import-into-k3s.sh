...
k3s ctr images import images/appscode-charts-kubedb-opscenter-v2025.5.30.tar
...
k3s ctr images import images/appscode-charts-kubedb-v2025.5.30.tar
...
k3s ctr images import images/appscode-charts-kubestash-v2025.4.30.tar
...
k3s ctr images import images/kubedb-kubedb-autoscaler-v0.40.0.tar
k3s ctr images import images/kubedb-kubedb-crd-manager-v0.10.0.tar
...
k3s ctr images import images/kubedb-kubedb-webhook-server-v0.31.0.tar
k3s ctr images import images/kubedb-pg-coordinator-v0.39.0.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.16.0_16.1-alpine.tar
k3s ctr images import images/kubedb-postgres-init-0.17.2.tar
k3s ctr images import images/kubedb-postgres-restic-plugin-v0.18.0_16.1.tar
k3s ctr images import images/kubedb-redis-coordinator-v0.34.0.tar
k3s ctr images import images/kubedb-redis-init-0.11.0.tar
k3s ctr images import images/kubedb-redis-restic-plugin-v0.18.0.tar

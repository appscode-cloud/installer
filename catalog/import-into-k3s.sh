...
k3s ctr images import images/appscode-charts-kubedb-v2025.3.24.tar
...
k3s ctr images import images/appscode-charts-kubestash-v2025.3.24.tar
...
k3s ctr images import images/appscode-cluster-ui-1.1.0.tar
...
k3s ctr images import images/appscode-kubedb-ui-1.1.0.tar
...
k3s ctr images import images/appscode-platform-ui-1.1.0.tar
...
k3s ctr images import images/kubedb-pg-coordinator-v0.37.0.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.14.0_16.1-alpine.tar
...
k3s ctr images import images/kubedb-redis-coordinator-v0.32.0.tar

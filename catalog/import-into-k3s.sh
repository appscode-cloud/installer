...
k3s ctr images import images/appscode-images-ingress-nginx-controller-v1.13.1.tar
...
k3s ctr images import images/appscode-external-dns-operator-v0.3.0.tar
...
k3s ctr images import images/appscode-kube-ui-server-v0.0.69.tar
...
k3s ctr images import images/appscode-outboxsyncer-v0.2.0.tar
k3s ctr images import images/appscode-panopticon-v0.0.21.tar
k3s ctr images import images/appscode-petset-v0.0.16.tar
k3s ctr images import images/appscode-pgoutbox-v0.0.3.tar
k3s ctr images import images/appscode-platform-ui-2.0.0.tar
k3s ctr images import images/appscode-prom-authproxy-v0.0.2.tar
...
k3s ctr images import images/kluster-manager-addon-manager-v1.0.0.tar
...
k3s ctr images import images/kubedb-kubedb-autoscaler-v0.45.0.tar
k3s ctr images import images/kubedb-kubedb-crd-manager-v0.15.0.tar
k3s ctr images import images/kubedb-kubedb-ops-manager-v0.47.0.tar
k3s ctr images import images/kubedb-kubedb-provisioner-v0.60.0.tar
k3s ctr images import images/kubedb-kubedb-schema-manager-v0.36.0.tar
k3s ctr images import images/kubedb-kubedb-ui-server-v0.36.0.tar
...
k3s ctr images import images/kubedb-postgres-archiver-v0.21.0_16.1-alpine.tar
k3s ctr images import images/kubedb-postgres-init-0.18.0.tar
k3s ctr images import images/kubedb-postgres-restic-plugin-v0.23.0_16.1.tar
...
k3s ctr images import images/kubedb-redis-restic-plugin-v0.23.0.tar
...
k3s ctr images import images/jetstack-cert-manager-acmesolver-v1.19.2.tar
k3s ctr images import images/jetstack-cert-manager-cainjector-v1.19.2.tar
k3s ctr images import images/jetstack-cert-manager-controller-v1.19.2.tar
k3s ctr images import images/jetstack-cert-manager-startupapicheck-v1.19.2.tar
k3s ctr images import images/jetstack-cert-manager-webhook-v1.19.2.tar
...
k3s ctr images import images/rancher-klipper-lb-v0.4.13.tar
k3s ctr images import images/rancher-local-path-provisioner-v0.0.32.tar
k3s ctr images import images/rancher-mirrored-coredns-coredns-1.13.1.tar
k3s ctr images import images/rancher-mirrored-library-busybox-1.37.0.tar
k3s ctr images import images/rancher-mirrored-pause-3.6.tar

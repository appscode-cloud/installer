...
k3s ctr images import images/appscode-charts-kubedb-opscenter-v2025.8.31.tar
...
k3s ctr images import images/appscode-charts-kubedb-v2025.8.31.tar
...
k3s ctr images import images/appscode-cluster-ui-1.9.0.tar
...
k3s ctr images import images/appscode-petset-v0.0.12.tar
k3s ctr images import images/appscode-platform-ui-1.9.0.tar
...
k3s ctr images import images/kubedb-kubedb-ops-manager-v0.45.0.tar
k3s ctr images import images/kubedb-kubedb-provisioner-v0.58.0.tar
k3s ctr images import images/kubedb-kubedb-schema-manager-v0.34.0.tar
k3s ctr images import images/kubedb-kubedb-ui-server-v0.34.0.tar
k3s ctr images import images/kubedb-kubedb-webhook-server-v0.34.0.tar
k3s ctr images import images/kubedb-pg-coordinator-v0.42.0.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.19.0_16.1-alpine.tar
k3s ctr images import images/kubedb-postgres-init-0.17.2.tar
k3s ctr images import images/kubedb-postgres-restic-plugin-v0.21.0_16.1.tar
k3s ctr images import images/kubedb-redis-coordinator-v0.37.0.tar
k3s ctr images import images/kubedb-redis-init-0.12.0.tar
k3s ctr images import images/kubedb-redis-restic-plugin-v0.21.0.tar

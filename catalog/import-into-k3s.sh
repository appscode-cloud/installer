...
k3s ctr images import images/kubedb-kubedb-ops-manager-v0.50.0.tar
k3s ctr images import images/kubedb-kubedb-provisioner-v0.63.0.tar
k3s ctr images import images/kubedb-kubedb-schema-manager-v0.39.0.tar
k3s ctr images import images/kubedb-kubedb-ui-server-v0.39.0.tar
k3s ctr images import images/kubedb-kubedb-webhook-server-v0.39.0.tar
k3s ctr images import images/kubedb-pg-coordinator-v0.47.0.tar
k3s ctr images import images/kubedb-postgres-archiver-v0.24.0_16.1-alpine.tar
k3s ctr images import images/kubedb-postgres-init-0.19.0.tar
k3s ctr images import images/kubedb-postgres-restic-plugin-v0.26.0_16.1.tar

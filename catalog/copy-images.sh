...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-crd-manager:v0.18.0 $IMAGE_REGISTRY/kubedb/kubedb-crd-manager:v0.18.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-ops-manager:v0.50.0 $IMAGE_REGISTRY/kubedb/kubedb-ops-manager:v0.50.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-provisioner:v0.63.0 $IMAGE_REGISTRY/kubedb/kubedb-provisioner:v0.63.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-schema-manager:v0.39.0 $IMAGE_REGISTRY/kubedb/kubedb-schema-manager:v0.39.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-ui-server:v0.39.0 $IMAGE_REGISTRY/kubedb/kubedb-ui-server:v0.39.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-webhook-server:v0.39.0 $IMAGE_REGISTRY/kubedb/kubedb-webhook-server:v0.39.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/pg-coordinator:v0.47.0 $IMAGE_REGISTRY/kubedb/pg-coordinator:v0.47.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.24.0_16.1-alpine $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.24.0_16.1-alpine
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-restic-plugin:v0.26.0_16.1 $IMAGE_REGISTRY/kubedb/postgres-restic-plugin:v0.26.0_16.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/redis-coordinator:v0.42.0 $IMAGE_REGISTRY/kubedb/redis-coordinator:v0.42.0

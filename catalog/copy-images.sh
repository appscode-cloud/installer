...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-images/ingress-nginx-controller:v1.13.1 $IMAGE_REGISTRY/appscode-images/ingress-nginx-controller:v1.13.1
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode/external-dns-operator:v0.3.0 $IMAGE_REGISTRY/appscode/external-dns-operator:v0.3.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode/gotenberg:8.25 $IMAGE_REGISTRY/appscode/gotenberg:8.25
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode/grafana-tools:v0.5.0 $IMAGE_REGISTRY/appscode/grafana-tools:v0.5.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode/kube-ui-server:v0.0.69 $IMAGE_REGISTRY/appscode/kube-ui-server:v0.0.69
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode/prom-authproxy:v0.0.2 $IMAGE_REGISTRY/appscode/prom-authproxy:v0.0.2
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-provisioner:v0.60.0 $IMAGE_REGISTRY/kubedb/kubedb-provisioner:v0.60.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-schema-manager:v0.36.0 $IMAGE_REGISTRY/kubedb/kubedb-schema-manager:v0.36.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-ui-server:v0.36.0 $IMAGE_REGISTRY/kubedb/kubedb-ui-server:v0.36.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-webhook-server:v0.36.0 $IMAGE_REGISTRY/kubedb/kubedb-webhook-server:v0.36.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.21.0_16.1-alpine $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.21.0_16.1-alpine
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-restic-plugin:v0.23.0_16.1 $IMAGE_REGISTRY/kubedb/postgres-restic-plugin:v0.23.0_16.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/redis-coordinator:v0.39.0 $IMAGE_REGISTRY/kubedb/redis-coordinator:v0.39.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/redis-restic-plugin:v0.23.0 $IMAGE_REGISTRY/kubedb/redis-restic-plugin:v0.23.0
...
$CMD cp --allow-nondistributable-artifacts --insecure hashicorp/vault-csi-provider:1.4.1 $IMAGE_REGISTRY/vault-csi-provider:1.4.1
...
$CMD cp --allow-nondistributable-artifacts --insecure quay.io/jetstack/cert-manager-acmesolver:v1.19.2 $IMAGE_REGISTRY/jetstack/cert-manager-acmesolver:v1.19.2
$CMD cp --allow-nondistributable-artifacts --insecure quay.io/jetstack/cert-manager-cainjector:v1.19.2 $IMAGE_REGISTRY/jetstack/cert-manager-cainjector:v1.19.2
...
$CMD cp --allow-nondistributable-artifacts --insecure rancher/klipper-lb:v0.4.13 $IMAGE_REGISTRY/rancher/klipper-lb:v0.4.13
$CMD cp --allow-nondistributable-artifacts --insecure rancher/local-path-provisioner:v0.0.32 $IMAGE_REGISTRY/rancher/local-path-provisioner:v0.0.32
$CMD cp --allow-nondistributable-artifacts --insecure rancher/mirrored-coredns-coredns:1.13.1 $IMAGE_REGISTRY/rancher/mirrored-coredns-coredns:1.13.1
$CMD cp --allow-nondistributable-artifacts --insecure rancher/mirrored-library-busybox:1.37.0 $IMAGE_REGISTRY/rancher/mirrored-library-busybox:1.37.0
$CMD cp --allow-nondistributable-artifacts --insecure rancher/mirrored-pause:3.6 $IMAGE_REGISTRY/rancher/mirrored-pause:3.6

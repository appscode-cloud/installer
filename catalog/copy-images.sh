...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/autoscalingkubedbcom-mongodbautoscaler-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/autoscalingkubedbcom-mongodbautoscaler-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/autoscalingkubedbcom-mysqlautoscaler-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/autoscalingkubedbcom-mysqlautoscaler-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/autoscalingkubedbcom-perconaxtradbautoscaler-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/autoscalingkubedbcom-perconaxtradbautoscaler-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/autoscalingkubedbcom-pgbouncerautoscaler-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/autoscalingkubedbcom-pgbouncerautoscaler-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/autoscalingkubedbcom-pgpoolautoscaler-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/autoscalingkubedbcom-pgpoolautoscaler-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/autoscalingkubedbcom-postgresautoscaler-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/autoscalingkubedbcom-postgresautoscaler-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/autoscalingkubedbcom-proxysqlautoscaler-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/autoscalingkubedbcom-proxysqlautoscaler-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/autoscalingkubedbcom-redisautoscaler-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/autoscalingkubedbcom-redisautoscaler-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/autoscalingkubedbcom-redissentinelautoscaler-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/autoscalingkubedbcom-redissentinelautoscaler-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/autoscalingkubedbcom-singlestoreautoscaler-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/autoscalingkubedbcom-singlestoreautoscaler-editor:v0.8.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/chartsxhelmdev-clusterchartpreset-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/chartsxhelmdev-clusterchartpreset-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/chartsxhelmdev-clusterchartpreset-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/chartsxhelmdev-clusterchartpreset-editor:v0.8.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/corekubestashcom-backupbatch-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/corekubestashcom-backupbatch-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/corekubestashcom-backupblueprint-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/corekubestashcom-backupblueprint-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/corekubestashcom-backupconfiguration-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/corekubestashcom-backupconfiguration-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/corekubestashcom-backupconfiguration-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/corekubestashcom-backupconfiguration-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/corekubestashcom-backupsession-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/corekubestashcom-backupsession-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/corekubestashcom-backupsession-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/corekubestashcom-backupsession-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/corekubestashcom-hooktemplate-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/corekubestashcom-hooktemplate-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/corekubestashcom-restoresession-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/corekubestashcom-restoresession-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/corekubestashcom-restoresession-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/corekubestashcom-restoresession-editor:v0.8.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kube-ui-server:v2024.10.17 $IMAGE_REGISTRY/appscode-charts/kube-ui-server:v2024.10.17
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-clickhouse-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-clickhouse-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-druid-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-druid-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-druid-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-druid-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-elasticsearch-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-elasticsearch-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-elasticsearch-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-elasticsearch-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-ferretdb-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-ferretdb-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-ferretdb-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-ferretdb-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-kafka-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-kafka-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-kafka-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-kafka-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-mariadb-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-mariadb-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-mariadb-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-mariadb-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-memcached-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-memcached-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-memcached-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-memcached-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-mongodb-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-mongodb-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-mongodb-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-mongodb-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-mssqlserver-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-mssqlserver-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-mssqlserver-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-mssqlserver-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-mysql-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-mysql-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-mysql-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-mysql-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-perconaxtradb-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-perconaxtradb-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-perconaxtradb-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-perconaxtradb-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-pgbouncer-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-pgbouncer-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-pgbouncer-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-pgbouncer-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-pgpool-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-pgpool-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-pgpool-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-pgpool-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-postgres-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-postgres-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-postgres-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-postgres-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-proxysql-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-proxysql-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-proxysql-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-proxysql-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-rabbitmq-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-rabbitmq-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-rabbitmq-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-rabbitmq-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-redis-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-redis-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-redis-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-redis-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-redissentinel-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-redissentinel-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-singlestore-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-singlestore-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-singlestore-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-singlestore-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-solr-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-solr-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-solr-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-solr-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-zookeeper-editor-options:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-zookeeper-editor-options:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/kubedbcom-zookeeper-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/kubedbcom-zookeeper-editor:v0.8.0
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-memcachedopsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-memcachedopsrequest-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-mongodbopsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-mongodbopsrequest-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-mssqlserveropsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-mssqlserveropsrequest-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-mysqlopsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-mysqlopsrequest-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-perconaxtradbopsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-perconaxtradbopsrequest-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-pgbounceropsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-pgbounceropsrequest-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-pgpoolopsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-pgpoolopsrequest-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-postgresopsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-postgresopsrequest-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-proxysqlopsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-proxysqlopsrequest-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-redisopsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-redisopsrequest-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-redissentinelopsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-redissentinelopsrequest-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-singlestoreopsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-singlestoreopsrequest-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-solropsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-solropsrequest-editor:v0.8.0
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/appscode-charts/opskubedbcom-zookeeperopsrequest-editor:v0.8.0 $IMAGE_REGISTRY/appscode-charts/opskubedbcom-zookeeperopsrequest-editor:v0.8.0

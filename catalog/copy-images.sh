...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-autoscaler:v0.46.0-rc.1 $IMAGE_REGISTRY/kubedb/kubedb-autoscaler:v0.46.0-rc.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-crd-manager:v0.16.0-rc.1 $IMAGE_REGISTRY/kubedb/kubedb-crd-manager:v0.16.0-rc.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-ops-manager:v0.48.0-rc.1 $IMAGE_REGISTRY/kubedb/kubedb-ops-manager:v0.48.0-rc.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-provisioner:v0.61.0-rc.1 $IMAGE_REGISTRY/kubedb/kubedb-provisioner:v0.61.0-rc.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-schema-manager:v0.37.0-rc.1 $IMAGE_REGISTRY/kubedb/kubedb-schema-manager:v0.37.0-rc.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-ui-server:v0.37.0-rc.1 $IMAGE_REGISTRY/kubedb/kubedb-ui-server:v0.37.0-rc.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/kubedb-webhook-server:v0.37.0-rc.1 $IMAGE_REGISTRY/kubedb/kubedb-webhook-server:v0.37.0-rc.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/pg-coordinator:v0.45.0-rc.1 $IMAGE_REGISTRY/kubedb/pg-coordinator:v0.45.0-rc.1
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/postgres-archiver:v0.22.0-rc.1_16.1-alpine $IMAGE_REGISTRY/kubedb/postgres-archiver:v0.22.0-rc.1_16.1-alpine
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/redis-coordinator:v0.40.0-rc.1 $IMAGE_REGISTRY/kubedb/redis-coordinator:v0.40.0-rc.1
...
$CMD cp --allow-nondistributable-artifacts --insecure ghcr.io/kubedb/redis-restic-plugin:v0.24.0-rc.1 $IMAGE_REGISTRY/kubedb/redis-restic-plugin:v0.24.0-rc.1
